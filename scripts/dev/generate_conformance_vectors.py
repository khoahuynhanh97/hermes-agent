...
def _oracles() -> Dict[str, Callable[[str], str]]:
    ...
    from hermes.integrations.plugins.platforms.slack.adapter import SlackAdapter
    from hermes.integrations.plugins.platforms.discord.adapter import DiscordAdapter
