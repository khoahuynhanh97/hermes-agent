...
def run_one(scenario: Dict[str, Any], mode: str, rep: int, out_dir: Path) -> Dict[str, Any]:
    ...
    try:
        ...
        from hermes.channels.cli.plugins import get_plugin_manager, discover_plugins
        ...
        from hermes.agent import conversation_loop as _cl
        ...
        try:
            from hermes.agent import conversation_loop as _cl2
