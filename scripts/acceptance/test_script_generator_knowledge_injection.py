...
from hermes.application import core
from hermes.application.core import knowledge_store, style_profiler
...
from hermes.application.core.script_generator import generate_script

# Mock requests.post to avoid hitting real Gemini API endpoints
from hermes.application.core import script_generator
import requests
