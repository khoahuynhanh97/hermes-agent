...
from gui.theme import COLORS, font, mono, primary_button_kwargs, secondary_button_kwargs
from gui.components import LabeledEntry, LabeledTextbox
import config
...
class PromptCompilerTab:
    ...
    def save_to_library(self):
        ...
        lib_dir = os.path.join(os.path.dirname(__file__), "..", "prompt_library", "templates")
