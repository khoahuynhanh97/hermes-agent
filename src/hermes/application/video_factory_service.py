...
from hermes.runtime_layout import get_product_intelligence_data_root, get_data_root
...
class VideoFactoryService:
    ...
    def save_storyboard(self, owner_user_id: str, project_id: str, storyboard: Storyboard) -> VideoFactoryProject:
        ...
        return self.repository.save(replace(
            ...
            final_approval=FinalApprovalStatus.PENDING,
    ...
    def _validate_asset_uri(uri: str) -> None:
        ...
        allowed_roots = [root, get_data_path(), get_data_root()]
        pi_data_root = get_product_intelligence_data_root()
        if pi_data_root is not None:
            allowed_roots.append(pi_data_root)
