...
from hermes.agent.tool_dispatch_helpers import make_tool_result_message
...
def create_environment(
    ...
    **kwargs
    ...
    if env_type == "local":
        ...
        from hermes.tools.environments.docker import DockerEnvironment
        return DockerEnvironment(image=image, cwd=cwd, timeout=timeout, **kwargs)
    
    elif env_type == "modal":
        from hermes.tools.environments.modal import ModalEnvironment
