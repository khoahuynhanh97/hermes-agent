...
# ---------------------------------------------------------------------------
from hermes.tools.interrupt import is_interrupted, _interrupt_event  # noqa: F401 — re-exported
...
from hermes.tools.environments.singularity import _get_scratch_dir
from hermes.tools.tool_backend_helpers import (
    coerce_modal_mode,
...
from hermes.tools.environments.local import LocalEnvironment as _LocalEnvironment
from hermes.tools.environments.singularity import SingularityEnvironment as _SingularityEnvironment
from hermes.tools.environments.ssh import SSHEnvironment as _SSHEnvironment
from hermes.tools.environments.docker import DockerEnvironment as _DockerEnvironment
from hermes.tools.environments.modal import ModalEnvironment as _ModalEnvironment
from hermes.tools.environments.managed_modal import ManagedModalEnvironment as _ManagedModalEnvironment
...
def _maybe_reap_docker_orphans(container_config: Dict[str, Any]) -> None:
    ...
    * ``_docker_orphan_reaper_ran`` flag — sweep runs once per Python
    ...
    try:
        from hermes.tools.environments.docker import (
...
def _ensure_terminal_env_bridged() -> None:
    ...
    try:
        from hermes.channels.cli.config import apply_terminal_config_to_env, read_raw_config
...
def _create_environment(env_type: str, image: str, cwd: str, timeout: int,
    ...
    if env_type == "local":
        ...
        from hermes.tools.environments.daytona import DaytonaEnvironment as _DaytonaEnvironment
        ...
        from hermes.tools.environments.vercel_sandbox import (
...
def _cleanup_inactive_envs(lifetime_seconds: int = 300):
    ...
    for task_id, env in envs_to_stop:
        ...
        try:
            from hermes.tools.file_tools import clear_file_ops_cache
...
def terminal_tool(
    ...
    try:
        ...
        from hermes.tools.approval import get_current_session_key
        ...
        if os.environ.get("_HERMES_GATEWAY") == "1":
            from hermes.scheduling.lifecycle_guard import (
        ...
        if background:
            ...
            try:
                ...
                if background and (notify_on_complete or watch_patterns):
                    from hermes.channels.gateway.session_context import (
            ...
            if _approved_run:
                from hermes.tools.interrupt import clear_current_thread_interrupt
            ...
            from hermes.tools.tool_output_limits import get_max_bytes
            ...
            from hermes.tools.ansi_strip import strip_ansi
            ...
            from hermes.agent.redact import redact_terminal_output
            ...
            if returncode != 0 and not exit_note:
                try:
                    from hermes.tools.terminal_hints import annotate_failure
            ...
            if spill_file_path:
                try:
                    ...
                    try:
                        ...
                        pass
            try:
                from hermes.agent.verification_evidence import record_terminal_result
...
def check_terminal_requirements() -> bool:
    ...
    try:
        ...
        if env_type == "local":
            ...
            from hermes.tools.environments.docker import find_docker
            docker = find_docker()
            if not docker:
