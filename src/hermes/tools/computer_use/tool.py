...
from hermes.tools.computer_use.backend import (
    ActionResult,
    CaptureResult,
    ComputerUseBackend,
    UIElement,
        ...
        with _backend_lock:
            ...
            if cached is not None:
                ...
                if backend_name in {"cua", "cua-driver", ""}:
                    from hermes.tools.computer_use.cua_backend import CuaDriverBackend
...
def _should_route_through_aux_vision() -> bool:
    ...
    try:
        ...
        from hermes.tools.computer_use.vision_routing import (
...
def check_computer_use_requirements() -> bool:
    ...
    if sys.platform not in ("darwin", "win32", "linux"):
        return False
    from hermes.tools.computer_use.cua_backend import cua_driver_binary_available
    return cua_driver_binary_available()


def get_computer_use_schema() -> Dict[str, Any]:
    from hermes.tools.computer_use.schema import COMPUTER_USE_SCHEMA
