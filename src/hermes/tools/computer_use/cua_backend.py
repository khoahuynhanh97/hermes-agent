...
from hermes.tools.computer_use.browser_route import CuaTypedBrowserRoute
...
class _EmbeddedCuaDaemon:
    ...
    def start(self) -> None:
        if self._process is not None and self._process.poll() is None:
            return
        from hermes.tools.environments.local import _sanitize_subprocess_env
...
class _CuaDriverSession:
    ...
    async def _populate_capabilities(self, session: Any) -> None:
        ...
        from hermes.tools/list. Soft prerequisite — discovery failure leaves
