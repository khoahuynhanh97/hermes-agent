...
for _stream in (sys.stdout, sys.stderr):
    if hasattr(_stream, "reconfigure"):
        try:
            ...
            pass
from hermes.runtime.constants import get_bundled_skills_dir, get_hermes_home, get_optional_skills_dir
...
def _build_external_skill_index() -> Set[str]:
    ...
    """
    try:
        from hermes.agent.skill_utils import get_external_skills_dirs, _external_dirs_cache_clear
    except ImportError:
        return set()
...
def _read_suppressed_names() -> set:
    ...
    """
    try:
        from hermes.tools.skill_usage import read_suppressed_names
...
def _content_hash(directory: Path) -> str:
    ...
    try:
        from hermes.tools.skills_guard import content_hash
