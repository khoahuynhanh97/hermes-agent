...
def _load_fal_client() -> Any:
    ...
    if fal_client is not None:
        return fal_client
    from hermes.tools.fal_common import import_fal_client
    fal_client = import_fal_client()
    return fal_client


from hermes.tools.debug_helpers import DebugSession
from hermes.tools.fal_common import (
...
def _active_terminal_env(task_id: str | None):
    try:
        from hermes.tools.terminal_tool import get_active_env
...
def _agent_visible_cache_path(host_path: str, env: Any) -> str | None:
    ...
    try:
        from hermes.tools.credential_files import map_cache_path_to_container
...
def _dispatch_to_plugin_provider(
    ...
    try:
        ...
        if reference_image_urls is not None:
            from hermes.agent.image_gen_provider import normalize_reference_images
...
def _maybe_route_managed_krea(
    ...
    try:
        from hermes.integrations.plugins.image_gen.krea import _resolve_managed_krea_gateway
