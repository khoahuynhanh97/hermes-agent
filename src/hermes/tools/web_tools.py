...
from hermes.integrations.plugins.web.firecrawl.provider import (
    Firecrawl,  # noqa: F401  # re-exported for tests that mock.patch("tools.web_tools.Firecrawl")
    _firecrawl_backend_help_suffix,
    _get_firecrawl_client,  # noqa: F401  # re-exported for tests that `from hermes.tools.web_tools import _get_firecrawl_client`
...
from hermes.integrations.plugins.web.tavily.provider import (  # noqa: F401 — backward-compat names
...
from hermes.integrations.plugins.web.parallel.provider import (  # noqa: F401 — backward-compat names
    _get_async_parallel_client,
    _get_parallel_client,
)
from hermes.integrations.plugins.web.exa.provider import _get_exa_client  # noqa: F401
...
from hermes.tools.debug_helpers import DebugSession
...
from hermes.tools.managed_tool_gateway import (  # noqa: F401 — backward-compat names for tests
    build_vendor_gateway_url,
    peek_nous_access_token as _peek_nous_access_token,
    read_nous_access_token as _read_nous_access_token,
    resolve_managed_tool_gateway,
)
from hermes.tools.tool_backend_helpers import (  # noqa: F401
    managed_nous_tools_enabled,
    nous_tool_gateway_unavailable_message,
    prefers_gateway,
)
from hermes.tools.url_safety import async_is_safe_url, normalize_url_for_request, sensitive_query_param_name
import sys
...
def _list_registered_web_providers():
    ...
    try:
        from hermes.agent.web_search_registry import list_providers
...
def _is_backend_available(backend: str) -> bool:
    ...
    if backend == "xai":
        ...
        try:
            from hermes.tools.xai_http import has_xai_credentials
...
def web_search_tool(query: str, limit: int = 5) -> str:
    ...
    try:
        ...
        from hermes.agent.web_search_registry import (
            ...
            if disabled_key:
                ...
                response_data = {
                    ...
                    "error": (
                        ...
                        "(or remove it from hermes.integrations.plugins.disabled)."
                    ),
                }
            else:
                response_data = {
...
if __name__ == "__main__":
    ...
    from hermes.channels.cli.config import get_env_value as _gev
