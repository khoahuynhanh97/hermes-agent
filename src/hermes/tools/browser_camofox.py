...
from hermes.channels.cli.config import cfg_get, load_config, read_raw_config
from hermes.tools.browser_camofox_state import get_camofox_identity
...
def camofox_type(ref: str, text: str, task_id: Optional[str] = None) -> str:
    ...
    try:
        ...
        from hermes.agent.display import redact_browser_typed_text_for_display
