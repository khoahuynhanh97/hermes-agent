...
Usage:
    from hermes.tools.toolsets import get_toolset, resolve_toolset, get_all_toolsets
...
_HERMES_CORE_TOOLS = [
    ...
    "vision_analyze", "image_generate", "product_to_video",
...
TOOLSETS = {
    ...
    "video_factory": {
        "description": "Product-to-Video and video creation orchestration tools",
        "tools": ["product_to_video"],
        "includes": []
    },
