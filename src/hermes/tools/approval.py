...
from hermes.runtime.utils import env_var_enabled, is_truthy_value
...
def _run_approval_gate(
    *,
    ...
    if approval_callback is None:
        try:
            from hermes.tools.terminal_tool import _get_approval_callback
    ...
    if not is_cli and not is_gateway and not is_ask:
        ...
        if _is_cron_approval_context():
            if _get_cron_approval_mode() == "deny":
                ...
                try:
                    from hermes.tools.tirith_security import check_command_security
                    ...
                    try:
                        from hermes.channels.cli.config import load_config_readonly as _load_cfg
