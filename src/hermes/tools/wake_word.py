...
def enrolled_profile_phrases() -> Dict[str, str]:
    ...
    try:
        ...
        from hermes.channels.cli.profiles import get_profile_dir, list_profiles
...
def _stt_ready() -> bool:
    ...
    """
    try:
        from hermes.tools.transcription_tools import _get_provider, _load_stt_config, is_stt_enabled
...
def _tts_ready() -> bool:
    ...
    """
    try:
        from hermes.tools.tts_tool import _get_provider, _load_tts_config
