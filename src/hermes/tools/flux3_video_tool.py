...
from hermes.tools.managed_tool_gateway import (
...
async def _deliver_media(value, permitted: tuple, task_id: Optional[str]):
    ...
    from hermes.tools.image_source import ImageResolutionError, ResolveContext, resolve_image_source
...
def _delivers_as_an_attachment() -> bool:
    ...
    """
    try:
        from hermes.channels.gateway.session_context import session_is_messaging_surface
