...
from hermes.channels.cli.goals import judge_goal
...
def _connect(board: Optional[str] = None):
    ...
    """
    from hermes.channels.cli import kanban_db as kb
...
def _goal_judge_available() -> bool:
    ...
    """
    try:
        from hermes.agent.auxiliary_client import get_text_auxiliary_client
