...
def _handle_list():
    ...
    try:
        from hermes.channels.gateway.channel_directory import format_directory_for_display
...
def _handle_react(args, remove=False):
    ...
    if adapter is None:
        return tool_error(
            ...
            "gateway (not available from hermes.scheduling/standalone contexts)."
        )
...
def _handle_send(args):
    ...
    if not chat_id:
        ...
        if not home and platform_name == "weixin":
            ...
            if wx_home:
                from hermes.channels.gateway.config import HomeChannel
...
def _parse_target_ref(platform_name: str, target_ref: str):
    ...
    if platform_name == "telegram":
        ...
        from hermes.integrations.plugins.platforms.telegram.telegram_ids import (
...
async def _send_to_platform(platform, pconfig, chat_id, message, thread_id=None, media_files=None, force_document=False):
    ...
    from hermes.channels.gateway.platforms.base import BasePlatformAdapter, utf16_len

    # Telegram adapter import is optional (requires python-telegram-bot)
    try:
        from hermes.integrations.plugins.platforms.telegram.adapter import TelegramAdapter
    ...
    if platform == Platform.FEISHU and media_files:
        from hermes.channels.gateway.platform_registry import platform_registry as _pr_feishu
        from hermes.channels.cli.plugins import discover_plugins as _dp_feishu
        _dp_feishu()
    ...
    if platform == Platform.SLACK and media_files:
        from hermes.channels.gateway.platform_registry import platform_registry as _pr_slack
        from hermes.channels.cli.plugins import discover_plugins as _dp_slack
        _dp_slack()
    ...
    if platform == Platform.WHATSAPP and media_files:
        from hermes.channels.gateway.platform_registry import platform_registry as _pr_wa
        from hermes.channels.cli.plugins import discover_plugins as _dp_wa
        _dp_wa()
...
async def _send_telegram(token, chat_id, message, media_files=None, thread_id=None, disable_link_previews=False, force_document=False):
    ...
    try:
        ...
        try:
            from hermes.channels.gateway.platforms.base import resolve_proxy_url
        ...
        _tg_caption = None
        from hermes.channels.gateway.platforms.base import utf16_len as _utf16_len
            ...
            for chunk in text_chunks:
                try:
                    ...
                    if _is_telegram_thread_not_found(md_error) and text_kwargs.get("message_thread_id") is not None:
                        ...
                        if not _has_html:
                            try:
                                from hermes.integrations.plugins.platforms.telegram.adapter import _strip_mdv2
            ...
            try:
                with open(media_path, "rb") as f:
                    ...
                    if (ext in _VOICE_EXTS and is_voice) or ext in _TELEGRAM_SEND_AUDIO_EXTS:
                        try:
                            from hermes.integrations.plugins.platforms.telegram.adapter import _probe_voice_duration_seconds
...
async def _resolve_slack_user_target(token, chat_id):
    ...
    try:
        from hermes.channels.gateway.platforms.base import resolve_proxy_url, proxy_kwargs_for_aiohttp
...
async def _send_signal(extra, chat_id, message, media_files=None):
    ...
    from hermes.channels.gateway.platforms.signal_rate_limit import (
    ...
    from hermes.channels.gateway.platforms.signal_format import markdown_to_signal
...
async def _send_matrix_via_adapter(pconfig, chat_id, message, media_files=None, thread_id=None):
    ...
    try:
        from hermes.integrations.plugins.platforms.matrix.adapter import MatrixAdapter
    except ImportError:
...
async def _send_weixin(pconfig, chat_id, message, media_files=None):
    ...
    try:
        from hermes.channels.gateway.platforms.weixin import check_weixin_requirements, send_weixin_direct
...
async def _send_bluebubbles(extra, chat_id, message):
    ...
    try:
        from hermes.channels.gateway.platforms.bluebubbles import BlueBubblesAdapter, check_bluebubbles_requirements
...
def _check_send_message():
    ...
    if platform and platform != "local":
        return True
    try:
        from hermes.channels.gateway.status import is_gateway_running
...
async def _send_qqbot(pconfig, chat_id, message):
    ...
    from hermes.channels.gateway.config import _getenv
...
async def _send_yuanbao(chat_id, message, media_files=None):
    ...
    """
    try:
        from hermes.channels.gateway.platforms.yuanbao import get_active_adapter, send_yuanbao_direct
    except ImportError:
