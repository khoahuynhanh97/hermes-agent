...
from hermes.tools.tool_backend_helpers import resolve_openai_audio_api_key
from hermes.tools.tts_tool import _get_provider, _load_tts_config, get_env_value
...
def _resolve_key(env_var: str, provider_id: str) -> str:
    ...
    """
    try:
        from hermes.tools.tts_tool import _resolve_provider_key
...
class XAIStreamer(StreamingTTSProvider):
    ...
    async def _async_frames(self, text: str):
        ...
        from hermes.tools.tts_tool import DEFAULT_XAI_VOICE_ID
        from hermes.tools.xai_http import resolve_xai_http_credentials
