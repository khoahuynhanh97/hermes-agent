...
class MCPOAuthManager:
    ...
    def _build_provider(
        ...
        from hermes.tools.mcp_oauth import (
            HermesTokenStorage,
        ...
        from hermes.tools.mcp_oauth import apply_oauth_provider_defaults
        ...
        from hermes.tools.mcp_dashboard_oauth import get_dashboard_oauth_flow
    ...
    def remove(
        ...
        *,
        ...
        from hermes.tools.mcp_oauth import remove_oauth_tokens
    ...
    async def invalidate_if_disk_changed(
        ...
        *,
        ...
        """
        from hermes.tools.mcp_oauth import _get_token_dir, _safe_filename
