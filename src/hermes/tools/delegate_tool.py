...
from hermes.tools import file_state
from hermes.tools.terminal_tool import set_approval_callback as _set_subagent_approval_cb
...
def _build_child_agent(
    ...
    if parent_enabled is not None:
        ...
        from hermes.agent import model_tools
    ...
    from hermes.agent.delegation_context import delegated_child_context
...
def _run_single_child(
    ...
    **_kwargs,
    ...
    try:
        ...
        try:
            from hermes.tools.terminal_tool import get_session_cwd, record_session_cwd
        ...
        from hermes.tools.daemon_pool import DaemonThreadPoolExecutor
...
def _finalize_child_results(
    ...
    with _parent_finalization_lock(parent_agent):
        ...
        parent_session_id = getattr(parent_agent, "session_id", None)
        try:
            from hermes.channels.cli.plugins import invoke_hook as invoke_hook
        except Exception:
            invoke_hook = None
...
def delegate_task(
    ...
    from hermes.tools.delegation_live_log import (
    ...
    from hermes.tools.async_delegation import _current_origin_session_id
    ...
    if background:
        from hermes.tools.async_delegation import dispatch_async_delegation_batch
        ...
        try:
            from hermes.channels.gateway.session_context import async_delivery_supported
...
def _resolve_child_credential_pool(
    ...
    if effective_provider == "custom":
        try:
            from hermes.agent.credential_pool import get_custom_provider_pool_key, load_pool
...
def _resolve_delegation_credentials(cfg: dict, parent_agent) -> dict:
    ...
    if configured_base_url and not _is_native_sdk_provider:
        ...
        from hermes.channels.cli.runtime_provider import _detect_api_mode_for_url
...
def _load_config() -> dict:
    ...
    if not prefer_legacy:
        try:
            ...
            pass
    try:
        from hermes.channels.cli.classic_runtime import CLI_CONFIG
