...
def _get_active_adapter():
    ...
    try:
        from hermes.channels.gateway.platforms.yuanbao import get_active_adapter
...
async def search_sticker(query: str = "", limit: int = 10) -> dict:
    ...
    """
    from hermes.channels.gateway.platforms.yuanbao_sticker import search_stickers
...
from hermes.tools.registry import registry, tool_result  # noqa: E402
