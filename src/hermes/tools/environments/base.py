...
class BaseEnvironment(ABC):
    ...
    def _snapshot_excluded_passthrough_names(self) -> tuple[str, ...]:
        ...
        try:
            ...
            if is_multiplex_active():
                from hermes.tools.env_passthrough import get_all_passthrough
                names = (
                    *get_all_passthrough(),
    ...
    def execute(
        ...
        *,
        ...
        if rewrite_compound_background:
            from hermes.tools.terminal_tool import _rewrite_compound_background
    ...
    def _prepare_command(self, command: str) -> tuple[str, str | None]:
        ...
        from hermes.tools.terminal_tool import _transform_sudo_command
