...
from hermes.tools.environments.base import BaseEnvironment, _pipe_stdin
...
def _build_provider_env_blocklist() -> frozenset:
    ...
    try:
        from hermes.channels.cli.config import OPTIONAL_ENV_VARS
...
def _managed_runtime_path_entries() -> list[str]:
    ...
    """
    try:
        from hermes.runtime.constants import get_hermes_home, iter_hermes_node_dirs
