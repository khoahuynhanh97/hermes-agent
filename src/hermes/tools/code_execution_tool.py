...
def _scrub_child_env(source_env, is_passthrough=None, is_windows=None):
    ...
    if is_passthrough is None:
        try:
            from hermes.tools.env_passthrough import (
        ...
        try:
            from hermes.tools.env_passthrough import resolve_passthrough_value
        except Exception:
            resolve_passthrough_value = lambda _name, _fallback: None  # noqa: E731
    ...
    try:
        from hermes.agent.delegation_context import (
...
def _rpc_server_loop(
    ...
    """
    from hermes.agent.model_tools import handle_function_call
...
def execute_code(
    ...
    from hermes.tools.terminal_tool import _get_env_config, _docker_has_host_access
    ...
    from hermes.tools.approval import check_execute_code_guard
    ...
    from hermes.tools.interrupt import is_interrupted as _is_interrupted
    ...
    try:
        ...
        from hermes.runtime.constants import apply_subprocess_home_env
        ...
        try:
            from hermes.tools.environments.base import touch_activity_if_due
        except Exception:
...
def _resolve_child_cwd(mode: str, staging_dir: str, task_id: str = "") -> str:
    ...
    if task_id:
        ...
        try:
            from hermes.tools.file_tools import _registered_task_cwd_override
