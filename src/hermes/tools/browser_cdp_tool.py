...
def _resolve_cdp_endpoint() -> str:
    ...
    """
    try:
        from hermes.tools.browser_tool import _get_cdp_override  # type: ignore[import-not-found]
...
def _browser_cdp_private_guard(
    *,
    ...
    """
    try:
        from hermes.tools import browser_tool as bt  # type: ignore[import-not-found]
...
def _browser_cdp_check() -> bool:
    ...
    """
    try:
        from hermes.tools.browser_tool import (  # type: ignore[import-not-found]
