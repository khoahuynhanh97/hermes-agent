...
from hermes.runtime.time import now as _hermes_now
...
def _merge_mcp_into_per_job_toolsets(per_job: list[str], cfg: dict) -> list[str]:
    ...
    from hermes.channels.cli.tools_config import enabled_mcp_server_names
...
def _resolve_cron_enabled_toolsets(job: dict, cfg: dict) -> list[str] | None:
    ...
    try:
        from hermes.channels.cli.tools_config import _get_platform_tools  # lazy: avoid heavy import at cron module load
...
from hermes.scheduling.jobs import get_due_jobs, mark_job_run, save_job_output, advance_next_runs, claim_dispatch, heartbeat_run_claim
from hermes.scheduling.executions import create_execution, finish_execution, mark_execution_running
...
def _is_cron_silence_response(text: str) -> bool:
    ...
    """
    from hermes.channels.gateway.response_filters import is_autonomous_silence_response
...
def _maybe_mirror_cron_delivery(
    ...
    *,
    ...
    if not text:
        return
    try:
        from hermes.channels.gateway.mirror import mirror_to_session
        ...
        # "this came from hermes.scheduling" context that the dropped SQLite mirror metadata
...
def _seed_cron_thread_session(
    ...
    try:
        ...
        from hermes.channels.gateway.session import SessionSource
...
def _resolve_single_delivery_target(job: dict, deliver_value: str) -> Optional[dict]:
    ...
    if ":" in deliver_value:
        ...
        from hermes.tools.send_message_tool import _parse_target_ref
        ...
        try:
            from hermes.channels.gateway.channel_directory import resolve_channel_name
...
def _send_media_via_adapter(
    ...
    from hermes.channels.gateway.platforms.base import BasePlatformAdapter, should_send_media_as_audio
...
def _deliver_result(job: dict, content: str, adapters=None, loop=None) -> Optional[str]:
    ...
    from hermes.tools.send_message_tool import _send_to_platform
    ...
    from hermes.channels.gateway.platforms.base import BasePlatformAdapter
    ...
    for target in targets:
        ...
        from hermes.channels.gateway.delivery import resolve_delivery_transport
        ...
        if live_adapter_ready:
            ...
            from hermes.channels.gateway.delivery import (
                DeliveryRouter,
                DeliveryTarget,
                _looks_like_int,
...
def _build_job_prompt(job: dict, prerun_script: Optional[tuple] = None) -> str:
    ...
    if context_from:
        from hermes.scheduling.jobs import get_cron_output_dir
    ...
    from hermes.tools.skill_usage import bump_use
    from hermes.agent.skill_bundles import build_bundle_invocation_message, resolve_bundle_command_key
    from hermes.agent.skill_utils import normalize_skill_lookup_name
...
def _scan_assembled_cron_prompt(
    ...
    *,
    ...
    """
    from hermes.tools.cronjob_tools import _scan_cron_prompt, _scan_cron_skill_assembled
...
def _guard_job_credential_exfil(job: dict) -> None:
    ...
    """
    try:
        from hermes.tools.cronjob_tools import _validate_cron_base_url
...
def run_job(
    ...
    from hermes.channels.gateway.session_context import set_session_vars, clear_session_vars, _VAR_MAP
    ...
    try:
        ...
        from hermes.channels.cli.env_loader import (
            load_hermes_dotenv,
        ...
        try:
            from hermes.runtime.constants import apply_ipv4_preference
        ...
        try:
            from hermes.tools.mcp_tool import discover_mcp_tools
...
def tick(
    ...
    *,
    ...
    Args:
        ...
        adapters: Optional dict mapping Platform → live adapter (from hermes.channels.gateway)
        loop: Optional asyncio event loop (from hermes.channels.gateway) for live adapter sends
    ...
    try:
        ...
        if not due_jobs:
            ...
            try:
                from hermes.tools.mcp_tool import _kill_orphaned_mcp_children
