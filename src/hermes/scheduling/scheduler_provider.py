...
class CronScheduler(ABC):
    ...
    def recover_interrupted(self) -> int:
        ...
        from hermes.scheduling.executions import recover_interrupted_executions
    ...
    def fire_due(self, job_id: str, *, adapters: Any = None, loop: Any = None) -> bool:
        ...
        """
        from hermes.scheduling.jobs import claim_job_for_fire, get_job
        from hermes.scheduling.executions import create_execution
...
def resolve_cron_scheduler() -> "CronScheduler":
    ...
    try:
        from hermes.integrations.plugins.cron_providers import load_cron_scheduler
...
class InProcessCronScheduler(CronScheduler):
    ...
    def start(
        ...
        *,
        ...
        import logging
        from hermes.scheduling.scheduler import tick as cron_tick
