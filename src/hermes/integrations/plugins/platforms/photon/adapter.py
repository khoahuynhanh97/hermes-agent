...
from hermes.channels.gateway.platforms.helpers import compile_mention_patterns, strip_markdown
...
class PhotonAdapter(BasePlatformAdapter):
    ...
    async def send_image(
        ...
        try:
            from hermes.channels.gateway.platforms.base import cache_image_from_url
