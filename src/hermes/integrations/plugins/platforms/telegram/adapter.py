...
from hermes.channels.gateway.authz_mixin import _coerce_allow_set
...
from hermes.integrations.plugins.platforms.telegram.telegram_network import (
    TelegramFallbackTransport,
    discover_fallback_ips,
    parse_fallback_ip_env,
)
from hermes.runtime.utils import atomic_replace, env_float, env_int
...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _try_send_rich(
        ...
        if message_id is not None:
            ...
            try:
                from hermes.channels.gateway import rich_sent_store
    ...
    async def _run_post_connect_housekeeping(self) -> None:
        ...
        try:
            ...
            try:
                ...
                from hermes.channels.cli.commands import telegram_menu_commands, telegram_menu_max_commands
                if not self._bot:
                    return
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            from hermes.channels.gateway.platforms._http_client_limits import platform_httpx_limits
    ...
    def _build_provider_keyboard(self, providers: list, page: int = 0) -> tuple:
        ...
        """
        try:
            from hermes.channels.cli.models import group_providers
        except Exception:
    ...
    async def _handle_model_picker_callback(
        ...
        if data.startswith("mp:"):
            ...
            group_id = data[4:]
            try:
                from hermes.channels.cli.models import PROVIDER_GROUPS
    ...
    async def send_image(
        ...
        try:
            ...
            try:
                from hermes.channels.gateway.platforms.base import _ssrf_redirect_guard
                from hermes.tools.url_safety import create_ssrf_safe_async_client
    ...
    async def _cache_observed_media(self, msg: Message, event: MessageEvent) -> None:
        ...
        """
        from hermes.channels.gateway.platforms.base import cache_media_bytes
    ...
    async def _handle_sticker(self, msg: Message, event: "MessageEvent") -> None:
        ...
        """
        from hermes.channels.gateway.sticker_cache import (
...
def _resolve_notifications_mode() -> str:
    ...
    if not mode:
        try:
            ...
            from hermes.channels.gateway.run import cfg_get
...
async def _standalone_send(
    ...
    *,
    ...
    from hermes.tools.send_message_tool import _send_telegram
...
def interactive_setup() -> None:
    ...
    """
    from hermes.channels.cli import setup as _setup_mod
...
def _apply_yaml_config(yaml_cfg: dict, telegram_cfg: dict) -> dict | None:
    ...
    telegram_cfg block from hermes.channels.gateway/config.py::load_gateway_config(). Env vars
