...
from hermes.channels.gateway.platforms.helpers import redact_phone, strip_markdown
...
#
# Added when the SMS (Twilio) adapter moved from hermes.channels.gateway/platforms/sms.py into
...
async def _standalone_send(
    ...
    *,
    ...
    def _redacted_error(text):
        try:
            from hermes.tools.send_message_tool import _error as _e
            return _e(text)
        except Exception:
            return {"error": text}
