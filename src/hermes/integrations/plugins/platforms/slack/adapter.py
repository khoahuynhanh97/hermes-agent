...
from hermes.channels.gateway.platforms.helpers import MessageDeduplicator
...
def check_slack_requirements() -> bool:
    ...
    from hermes.tools.lazy_deps import ensure_and_bind
...
def _rewrite_known_bang_command(text: str) -> str:
    ...
    try:
        from hermes.channels.cli.commands import is_gateway_known_command
...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        if tokens_file.exists():
            try:
                ...
                from hermes.runtime.utils import warn_if_credential_file_broadly_readable
        ...
        try:
            ...
            from hermes.channels.cli.commands import slack_native_slashes
            import re as _re
    ...
    async def send_image(
        ...
        from hermes.tools.url_safety import create_ssrf_safe_async_client, is_safe_url
        ...
        try:
            async def _ssrf_redirect_guard(response):
                ...
                from hermes.tools.url_safety import redirect_target_from_response
    ...
    async def _handle_clarify_action(self, ack, body, action) -> None:
        ...
        from hermes.tools import clarify_gateway as _clarify_mod
    ...
    async def _format_thread_context(
        ...
        *,
        ...
        from hermes.channels.gateway.session import neutralize_untrusted_inline_text
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        if slash_name in {"hermes", ""}:
            ...
            from hermes.channels.cli.commands import slack_subcommand_map
    ...
    def _build_thread_session_key(
        ...
        *,
        ...
        if not session_store:
            return None
        try:
            from hermes.channels.gateway.session import SessionSource, build_session_key
    ...
    async def _download_slack_file(
        ...
        import httpx
        from hermes.channels.gateway.platforms.base import _ssrf_redirect_guard, safe_url_for_log
        from hermes.tools.url_safety import create_ssrf_safe_async_client, is_safe_url
...
async def _resolve_slack_user_dm(token: str, user_id: str) -> Optional[str]:
    ...
    try:
        ...
        return None
    try:
        from hermes.channels.gateway.platforms.base import proxy_kwargs_for_aiohttp
...
def interactive_setup() -> None:
    ...
    def _write_slack_manifest_and_instruct() -> None:
        ...
        try:
            from hermes.channels.cli.slack_cli import _build_full_manifest
            from hermes.runtime.constants import get_hermes_home
            import json as _json
