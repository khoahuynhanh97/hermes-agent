...
from hermes.channels.gateway.status import acquire_scoped_lock, release_scoped_lock
...
def _strip_markdown_to_plain_text(text: str) -> str:
    ...
    horizontal rules, \\r\\n normalisation).
    """
    from hermes.channels.gateway.platforms.helpers import strip_markdown
    plain = text.replace("\r\n", "\n")
...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def _on_drive_comment_event(self, data: Any) -> None:
        ...
        """
        from hermes.integrations.plugins.platforms.feishu.feishu_comment import handle_drive_comment_event
    ...
    def _on_meeting_invited_event(self, data: Any) -> None:
        ...
        from hermes.integrations.plugins.platforms.feishu.feishu_meeting_invite import handle_meeting_invited_event
...
# feishu_meeting_invite satellites) moved from hermes.channels.gateway/platforms/ into this
...
def interactive_setup() -> None:
    ...
    from hermes.channels.cli.setup import prompt_choice
...
def _apply_yaml_config(yaml_cfg: dict, feishu_cfg: dict) -> dict | None:
    ...
    feishu_cfg block from hermes.channels.gateway/config.py::load_gateway_config() (allow_bots).
