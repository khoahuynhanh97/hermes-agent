...
from hermes.channels.gateway.platforms.helpers import MessageDeduplicator, compile_mention_patterns
...
#
# Added when the DingTalk adapter moved from hermes.channels.gateway/platforms/dingtalk.py into
...
async def _standalone_send(
    ...
    *,
    ...
    try:
        ...
        try:
            from hermes.tools.send_message_tool import _error as _redact_error
...
def interactive_setup() -> None:
    ...
    """
    from hermes.channels.cli.config import get_env_value, save_env_value
    ...
    if method == 0:
        try:
            from hermes.channels.cli.dingtalk_auth import dingtalk_qr_auth
...
def _apply_yaml_config(yaml_cfg: dict, dingtalk_cfg: dict) -> dict | None:
    ...
    dingtalk_cfg block from hermes.channels.gateway/config.py::load_gateway_config(). Env vars
