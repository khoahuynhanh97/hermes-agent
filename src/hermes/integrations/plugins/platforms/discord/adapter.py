...
from hermes.agent.async_utils import (
    consume_detached_task_result as _consume_background_task_result,
)
from hermes.agent.display import ToolPreview
...
from hermes.channels.gateway.platforms.helpers import (
    MessageDeduplicator,
    ThreadParticipationTracker,
    convert_table_to_bullets,
)
from hermes.runtime.utils import atomic_json_write, env_float, env_int
...
from hermes.tools.url_safety import is_safe_url
...
def _scoped_gate_env(name: str, default: str = "") -> str:
    ...
    try:
        from hermes.channels.gateway.authz_mixin import _platform_gate_env
...
def _profile_scoped_config_load() -> bool:
    ...
    """
    try:
        from hermes.agent.secret_scope import current_secret_scope, is_multiplex_active
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        from hermes.runtime.constants import get_hermes_home
        from hermes.integrations.plugins.platforms.discord.recovery import DiscordRecoveryStore
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            from hermes.channels.gateway.platforms.base import resolve_proxy_url, proxy_kwargs_for_bot
    ...
    async def _process_voice_input(self, guild_id: int, user_id: int, pcm_data: bytes):
        ...
        from hermes.tools.voice_mode import is_whisper_hallucination
        ...
        try:
            ...
            from hermes.tools.transcription_tools import transcribe_audio
    ...
    def _register_slash_commands(self) -> None:
        ...
        dropped_over_cap = 0
        try:
            from hermes.channels.cli.commands import COMMAND_REGISTRY, _is_gateway_available, _resolve_config_gates
        ...
        try:
            from hermes.channels.cli.commands import _iter_plugin_command_entries
    ...
    def _refresh_skill_catalog_state(self) -> None:
        ...
        """
        from hermes.channels.cli.commands import discord_skill_commands_by_category
    ...
    def _resolve_channel_skills(self, channel_id: str, parent_id: str | None = None) -> list[str] | None:
        ...
        """
        from hermes.channels.gateway.platforms.base import resolve_channel_skills
        return resolve_channel_skills(self.config.extra, channel_id, parent_id)

    def _resolve_channel_prompt(self, channel_id: str, parent_id: str | None = None) -> str | None:
        """Resolve a Discord per-channel prompt, preferring the exact channel over its parent."""
        from hermes.channels.gateway.platforms.base import resolve_channel_prompt
    ...
    async def rename_thread(
        ...
        *,
        ...
        from hermes.channels.gateway.platforms.base import utf16_len, _prefix_within_utf16_limit
    ...
    def _text_batch_key(self, event: MessageEvent) -> str:
        ...
        """
        from hermes.channels.gateway.session import build_session_key
...
def _resolve_exec_approval_admin_gate(
    ...
    if not require_admin:
        return (False, set())
    try:
        from hermes.channels.gateway.slash_access import _coerce_id_list
...
def _define_discord_view_classes() -> None:
    ...
    class SlashConfirmView(discord.ui.View):
        ...
        async def _resolve(
            ...
            try:
                from hermes.tools import slash_confirm as _slash_confirm_mod
    ...
    class ClarifyChoiceView(discord.ui.View):
        ...
        async def _resolve_choice(
            ...
            try:
                from hermes.tools.clarify_gateway import _entries as _clarify_entries  # type: ignore
            ...
            try:
                from hermes.tools.clarify_gateway import resolve_gateway_clarify
        ...
        async def _on_other(self, interaction: "discord.Interaction") -> None:
            ...
            try:
                from hermes.tools.clarify_gateway import mark_awaiting_text
    ...
    *,
    ...
    try:
        ...
        if thread_id:
            ...
            _channel_type = None
            try:
                from hermes.channels.gateway.channel_directory import lookup_channel_type
...
def interactive_setup() -> None:
    ...
    """
    from hermes.channels.cli.config import get_env_value, remove_env_value, save_env_value
    from hermes.channels.cli.cli_output import (
        prompt,
        prompt_yes_no,
        print_header,
        print_info,
...
def _is_connected(config) -> bool:
    ...
    """
    import hermes.channels.gateway as gateway_mod
