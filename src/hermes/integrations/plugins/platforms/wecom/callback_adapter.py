...
from hermes.channels.gateway.platforms.base import BasePlatformAdapter, MessageEvent, MessageType, SendResult
from hermes.integrations.plugins.platforms.wecom.wecom_crypto import WXBizMsgCrypt, WeComCryptoError
