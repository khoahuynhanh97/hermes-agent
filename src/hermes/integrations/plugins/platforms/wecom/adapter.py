...
from hermes.runtime.utils import env_float
...
# wecom_crypto satellite) moved from hermes.channels.gateway/platforms/ into this bundled
...
def _build_callback_adapter(config):
    ...
    from hermes.integrations.plugins.platforms.wecom.callback_adapter import WecomCallbackAdapter
...
def register(ctx) -> None:
    ...
    from hermes.integrations.plugins.platforms.wecom.callback_adapter import check_wecom_callback_requirements
    ctx.register_platform(
        name="wecom_callback",
