...
from hermes.channels.cli.auth import get_auth_status
from hermes.integrations.plugins.spotify.client import (
    SpotifyAPIError,
...
from hermes.tools.registry import tool_error, tool_result
