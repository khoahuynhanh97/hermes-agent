...
from hermes.integrations.plugins.google_meet import process_manager as pm
from hermes.integrations.plugins.google_meet.meet_bot import _is_safe_meet_url
...
def register_cli(subparser: argparse.ArgumentParser) -> None:
    ...
    try:
        from hermes.integrations.plugins.google_meet.node.cli import register_cli as _register_node_cli
...
def _cmd_join(
    ...
    *,
    ...
    if node:
        ...
        try:
            from hermes.integrations.plugins.google_meet.node.registry import NodeRegistry
            from hermes.integrations.plugins.google_meet.node.client import NodeClient
