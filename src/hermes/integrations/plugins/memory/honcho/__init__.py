...
from hermes.agent.memory_provider import TRIVIAL_PROMPT_RE, MemoryProvider, is_trivial_prompt
...
# ---------------------------------------------------------------------------
# Tool schemas (moved from hermes.tools/honcho_tools.py)
# ---------------------------------------------------------------------------
...
class HonchoMemoryProvider(MemoryProvider):
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        import types
        from hermes.integrations.plugins.memory.honcho.cli import cmd_setup
    ...
    def _do_session_init(self, cfg, session_id: str, **kwargs) -> None:
        ...
        from hermes.integrations.plugins.memory.honcho.client import get_honcho_client
        from hermes.integrations.plugins.memory.honcho.session import HonchoSessionManager
...
def register(ctx) -> None:
    ...
    from hermes.integrations.plugins.memory.query_rewrite import rewrite_memory_query
