...
from hermes.integrations.plugins.memory.honcho.client import resolve_active_host, resolve_config_path
...
def complete_authorization(
    ...
    *,
    ...
    from hermes.integrations.plugins.memory.honcho.client import reset_honcho_client
