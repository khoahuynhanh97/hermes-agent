...
from hermes.agent.memory_provider import MemoryProvider
from hermes.agent.skill_commands import extract_user_instruction_from_skill_message
from hermes.tools.registry import tool_error
from hermes.runtime.utils import atomic_json_write, env_var_enabled
...
def _openviking_endpoint_is_always_blocked(candidate: str) -> bool:
    ...
    """
    from hermes.tools.url_safety import is_always_blocked_url
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        from hermes.channels.cli.memory_setup import _CANCELLED, _curses_select, _print_cancelled_setup, _prompt
