...
from hermes.agent.image_gen_provider import (
...
def _read_codex_access_token() -> Optional[str]:
    ...
    """
    try:
        from hermes.agent.auxiliary_client import _read_codex_access_token as _reader
...
def _sniff_image_mime(raw: bytes) -> Optional[str]:
    ...
    """
    from hermes.agent.image_routing import _sniff_mime_from_bytes
