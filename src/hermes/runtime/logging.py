...
from hermes.runtime.constants import get_config_path, get_hermes_home
...
def setup_logging(
    ...
    *force* is ``True``.
    ...
    from hermes.agent.redact import RedactingFormatter
...
def _read_logging_config():
    ...
    try:
        ...
        try:
            from hermes.channels.cli.config import read_raw_config as _rrc
            cfg = _rrc() or {}
        except Exception:
            from hermes.runtime.utils import fast_safe_load
