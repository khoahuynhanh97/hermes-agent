...
def harden_import_path(src_root: str | None = None) -> None:
    ...
    makes ``from hermes.runtime.utils import ...`` resolve to the *user's* package and crash
...
# Apply on import — entry points just need ``from hermes.runtime import bootstrap as hermes_bootstrap``
# (or ``from hermes.runtime.bootstrap import apply_windows_utf8_bootstrap``) at
