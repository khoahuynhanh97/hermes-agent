...
from hermes.runtime.constants import get_hermes_home
...
def _session_source_for_agent(platform: Optional[str]) -> str:
    try:
        from hermes.channels.gateway.session_context import get_session_env
...
# `mock.patch("run_agent.<X>")`, `from hermes.agent.runtime_agent import <X>` in production
# siblings, or the `_ra().<X>` indirection in agent/system_prompt.py — none
# of which ruff's in-module usage scan can see.
from hermes.agent.process_bootstrap import (
    OpenAI,  # noqa: F401  # re-exported for tests that mock.patch("run_agent.OpenAI")
    _SafeWriter,  # noqa: F401  # re-exported for tests that `from hermes.agent.runtime_agent import _SafeWriter`
    _get_proxy_for_base_url,
)
from hermes.agent.iteration_budget import IterationBudget
...
from hermes.channels.cli.timeouts import (
...
from hermes.agent.model_tools import (
...
from hermes.tools.terminal_tool import cleanup_vm, get_active_env
from hermes.tools.interrupt import set_interrupt as _set_interrupt
from hermes.tools.browser_tool import cleanup_browser


# Agent internals extracted to agent/ package for modularity
from hermes.agent.memory_manager import sanitize_context
from hermes.agent.memory_provider import is_trivial_prompt
from hermes.agent.error_classifier import FailoverReason
from hermes.agent.redact import redact_sensitive_text
from hermes.agent.message_content import flatten_message_text
from hermes.agent.session_activity import ActivityProvenance
from hermes.agent.model_metadata import (
    estimate_request_tokens_rough,  # noqa: F401  # re-exported for tests that mock.patch("run_agent.estimate_request_tokens_rough")
    is_local_endpoint,
)
from hermes.agent.usage_pricing import normalize_usage
# Re-exported for tests that monkeypatch these symbols on run_agent.
from hermes.agent.context_compressor import (  # noqa: F401
    COMPRESSED_SUMMARY_METADATA_KEY,
    ContextCompressor,
)
from hermes.agent.retry_utils import jittered_backoff  # noqa: F401
from hermes.agent.prompt_builder import (  # noqa: F401  # re-exported via _ra() / mock.patch("run_agent.<name>") / from hermes.agent.runtime_agent import <name>
...
from hermes.agent.process_bootstrap import _get_proxy_from_env  # noqa: F401
from hermes.agent.message_sanitization import (  # noqa: F401
    _SURROGATE_RE,
...
from hermes.agent.codex_responses_adapter import (
...
from hermes.agent.tool_guardrails import (
    ToolGuardrailDecision,
    append_toolguard_guidance,
    toolguard_synthetic_result,
)
from hermes.agent.tool_result_classification import (
    FILE_MUTATING_TOOL_NAMES as _FILE_MUTATING_TOOLS,
    file_mutation_result_landed,
)
from hermes.agent.trajectory import (
    convert_scratchpad_to_think,
    save_trajectory as _save_trajectory_to_file,
)
from hermes.agent.tool_dispatch_helpers import (
    _should_parallelize_tool_batch,  # noqa: F401  # re-exported for tests that `from hermes.agent.runtime_agent import _should_parallelize_tool_batch`
    _is_destructive_command,  # noqa: F401  # re-exported for tests that access `run_agent._is_destructive_command`
    _extract_parallel_scope_path,  # noqa: F401  # re-exported for tests that `from hermes.agent.runtime_agent import _extract_parallel_scope_path`
    _paths_overlap,  # noqa: F401  # re-exported for tests that `from hermes.agent.runtime_agent import _paths_overlap`
    _is_multimodal_tool_result,
    _multimodal_text_summary,
    _append_subdir_hint_to_multimodal,  # noqa: F401  # re-exported for tests that `from hermes.agent.runtime_agent import _append_subdir_hint_to_multimodal`
    _extract_file_mutation_targets,
    _extract_landed_file_mutation_paths,
    _extract_error_preview,
    _trajectory_normalize_msg,  # noqa: F401  # re-exported for tests that `from hermes.agent.runtime_agent import _trajectory_normalize_msg`
)
from hermes.runtime.utils import atomic_json_write, base_url_host_matches, base_url_hostname, env_float, is_truthy_value, model_forces_max_completion_tokens
...
def _routermint_headers() -> dict:
    ...
    from hermes.channels.cli import __version__ as _HERMES_VERSION
...
class AIAgent:
    ...
    def __init__(
        ...
        from hermes.agent.agent_init import init_agent
        init_agent(
            self,
            base_url=base_url,
            api_key=api_key,
    ...
    def _ensure_db_session(self) -> None:
        ...
        try:
            ...
            try:
                from hermes.tools.approval import is_session_yolo_enabled
    ...
    def _ensure_lmstudio_runtime_loaded(
        ...
        from hermes.channels.cli.models import ensure_lmstudio_model_loaded
    ...
    def switch_model(self, new_model, new_provider, api_key='', base_url='', api_mode=''):
        ...
        from hermes.agent.agent_runtime_helpers import switch_model
    ...
    from hermes.agent.stream_diag import STREAM_DIAG_HEADERS as _STREAM_DIAG_HEADERS  # noqa: E402

    @staticmethod
    def _stream_diag_init() -> Dict[str, Any]:
        """Forwarder — see ``agent.stream_diag.stream_diag_init``."""
        from hermes.agent.stream_diag import stream_diag_init
    ...
    def _stream_diag_capture_response(
        ...
        from hermes.agent.stream_diag import stream_diag_capture_response
    ...
    def _flatten_exception_chain(error: BaseException) -> str:
        ...
        from hermes.agent.stream_diag import flatten_exception_chain
    ...
    def _log_stream_retry(
        ...
        *,
        ...
        from hermes.agent.stream_diag import log_stream_retry
        log_stream_retry(
    ...
    def _emit_stream_drop(
        ...
        *,
        ...
        from hermes.agent.stream_diag import emit_stream_drop
        emit_stream_drop(
    ...
    def _check_compression_model_feasibility(self) -> None:
        ...
        from hermes.agent.conversation_compression import check_compression_model_feasibility
    ...
    def _replay_compression_warning(self) -> None:
        ...
        from hermes.agent.conversation_compression import replay_compression_warning
    ...
    def _resolved_api_call_stale_timeout_base(self) -> tuple[float, bool]:
        ...
        # local NIM endpoint.
        from hermes.agent.reasoning_timeouts import get_reasoning_stale_timeout_floor
    ...
    def _compute_non_stream_stale_timeout(self, api_payload: Any) -> float:
        ...
        from hermes.agent.chat_completion_helpers import estimate_request_context_tokens
    ...
    def _anthropic_prompt_cache_policy(
        ...
        *,
        ...
        from hermes.agent.agent_runtime_helpers import anthropic_prompt_cache_policy
    ...
    def _direct_native_anthropic_tool_cache_capability(
        ...
        *,
        ...
        from hermes.agent.agent_runtime_helpers import _direct_native_anthropic_tool_cache_capability
    ...
    def _provider_model_requires_responses_api(
        ...
        *,
        ...
        if normalized_provider == "copilot":
            try:
                from hermes.channels.cli.models import _should_use_copilot_responses_api
    ...
    def _strip_think_blocks(self, content: str) -> str:
        ...
        from hermes.agent.agent_runtime_helpers import strip_think_blocks
    ...
    def _looks_like_codex_intermediate_ack(
        ...
        from hermes.agent.agent_runtime_helpers import looks_like_codex_intermediate_ack
    ...
    def _extract_reasoning(self, assistant_message) -> Optional[str]:
        ...
        from hermes.agent.agent_runtime_helpers import extract_reasoning
    ...
    def _cleanup_task_resources(self, task_id: str) -> None:
        ...
        from hermes.agent.chat_completion_helpers import cleanup_task_resources
        return cleanup_task_resources(self, task_id)

    # ------------------------------------------------------------------
    # Background memory/skill review — prompts live in agent.background_review
    # ------------------------------------------------------------------
    from hermes.agent.background_review import (
    ...
    def _summarize_background_review_actions(
        ...
        from hermes.agent.background_review import summarize_background_review_actions
    ...
    def _spawn_background_review(
        ...
        keep working.
        """
        from hermes.agent.background_review import spawn_background_review_thread
        from hermes.tools.thread_context import propagate_context_to_thread
    ...
    def _build_memory_write_metadata(
        ...
        *,
        ...
        from hermes.agent.background_review import build_memory_write_metadata
    ...
    def _persist_session(self, messages: List[Dict], conversation_history: List[Dict] = None):
        ...
        from hermes.agent.agent_runtime_helpers import note_turn_persisted
    ...
    def _repair_message_sequence(self, messages: List[Dict]) -> int:
        ...
        from hermes.agent.agent_runtime_helpers import repair_message_sequence
    ...
    def _format_tools_for_system_message(self) -> str:
        ...
        from hermes.agent.system_prompt import format_tools_for_system_message
    ...
    def _convert_to_trajectory_format(self, messages: List[Dict[str, Any]], user_query: str, completed: bool) -> List[Dict[str, Any]]:
        ...
        from hermes.agent.agent_runtime_helpers import convert_to_trajectory_format
    ...
    def _extract_api_error_context(error: Exception) -> Dict[str, Any]:
        ...
        from hermes.agent.agent_runtime_helpers import extract_api_error_context
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        try:
            from hermes.channels.cli import lifecycle as _lifecycle
    ...
    def _dump_api_request_debug(
        ...
        *,
        ...
        from hermes.agent.agent_runtime_helpers import dump_api_request_debug
    ...
    def steer(self, text: str) -> bool:
        ...
        Thread-safe: callable from hermes.channels.gateway/CLI/TUI threads. Multiple calls
    ...
    def _apply_pending_steer_to_tool_results(self, messages: list, num_tool_msgs: int) -> None:
        ...
        from hermes.agent.agent_runtime_helpers import apply_pending_steer_to_tool_results
    ...
    def _touch_activity(
        ...
        *,
        ...
        """
        from hermes.agent.session_activity import (
        ...
        if os.environ.get("HERMES_KANBAN_TASK"):
            try:
                from hermes.tools.kanban_tools import (
    ...
    def _capture_rate_limits(self, http_response: Any) -> None:
        ...
        if not headers:
            return
        try:
            from hermes.agent.rate_limit_tracker import parse_rate_limit_headers
    ...
    def _capture_credits(self, http_response: Any) -> None:
        ...
        try:
            from hermes.agent.credits_tracker import dev_fixture_credits_state
        ...
        try:
            from hermes.agent.credits_tracker import parse_credits_headers
    ...
    def _emit_credits_notices(self) -> None:
        ...
        if state is None:
            return
        try:
            from hermes.agent.credits_tracker import evaluate_credits_notices, is_free_tier_model, new_credits_latch
    ...
    def close(self) -> None:
        ...
        try:
            from hermes.tools.computer_use import release_computer_use_session
        ...
        try:
            from hermes.channels.cli.mem_trim import trim_memory
    ...
    def _hydrate_todo_store(self, history: List[Dict[str, Any]]) -> None:
        ...
        (GHSA-5g4g-6jrg-mw3g).
        """
        from hermes.tools.todo_tool import MAX_TODO_RESULT_CHARS
    ...
    def _build_system_prompt_parts(self, system_message: str = None) -> Dict[str, str]:
        ...
        from hermes.agent.system_prompt import build_system_prompt_parts
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        from hermes.agent.system_prompt import build_system_prompt
    ...
    def _sanitize_api_messages(messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        from hermes.agent.agent_runtime_helpers import sanitize_api_messages
    ...
    def _drop_thinking_only_and_merge_users(
        ...
        *,
        ...
        from hermes.agent.agent_runtime_helpers import drop_thinking_only_and_merge_users
    ...
    def _cap_delegate_task_calls(tool_calls: list) -> list:
        ...
        """
        from hermes.tools.delegate_tool import _get_max_concurrent_children
    ...
    def _repair_tool_call(self, tool_name: str) -> str | None:
        ...
        from hermes.agent.agent_runtime_helpers import repair_tool_call
        return repair_tool_call(self, tool_name)

    def _invalidate_system_prompt(self):
        """Forwarder — see ``agent.system_prompt.invalidate_system_prompt``."""
        from hermes.agent.system_prompt import invalidate_system_prompt
    ...
    def _create_openai_client(self, client_kwargs: dict, *, reason: str, shared: bool) -> Any:
        ...
        from hermes.agent.agent_runtime_helpers import create_openai_client
    ...
    def _force_close_tcp_sockets(client: Any) -> int:
        ...
        from hermes.agent.agent_runtime_helpers import force_close_tcp_sockets
    ...
    def _cleanup_dead_connections(self) -> bool:
        ...
        from hermes.agent.agent_runtime_helpers import cleanup_dead_connections
    ...
    def _copilot_headers_for_request(self, *, is_vision: bool) -> dict:
        from hermes.channels.cli.copilot_auth import copilot_request_headers
    ...
    def _create_request_anthropic_client(self, *, reason: str) -> Any:
        ...
        if getattr(self, "provider", None) == "bedrock":
            from hermes.agent.anthropic_adapter import build_anthropic_bedrock_client
            region = getattr(self, "_bedrock_region", "us-east-1") or "us-east-1"
            client = build_anthropic_bedrock_client(region)
        else:
            from hermes.agent.anthropic_adapter import build_anthropic_client
    ...
    def _run_codex_stream(self, api_kwargs: dict, client: Any = None, on_first_delta: callable = None):
        ...
        from hermes.agent.codex_runtime import run_codex_stream
    ...
    def _run_codex_create_stream_fallback(self, api_kwargs: dict, client: Any = None):
        ...
        from hermes.agent.codex_runtime import run_codex_create_stream_fallback
    ...
    def _try_refresh_codex_client_credentials(self, *, force: bool = True) -> bool:
        ...
        try:
            if self.provider == "openai-codex":
                from hermes.channels.cli.auth import resolve_codex_runtime_credentials

                singleton_now = resolve_codex_runtime_credentials(
                    refresh_if_expiring=False,
                )
            else:
                from hermes.channels.cli.auth import resolve_xai_oauth_runtime_credentials
    ...
    def _try_refresh_nous_client_credentials(
        ...
        *,
        ...
        try:
            from hermes.channels.cli.auth import resolve_nous_runtime_credentials
    ...
    def _try_refresh_env_client_credentials(self) -> bool:
        ...
        if getattr(self, "_fallback_activated", False):
            return False
        try:
            from hermes.agent.credential_pool import get_env_prefer_dotenv
        ...
        if (
            ...
            if self.provider == "kimi-coding":
                from hermes.channels.cli.auth import _resolve_kimi_base_url

                base_url = _resolve_kimi_base_url(
                    api_key, pconfig.inference_base_url, env_url
                ).rstrip("/")
            elif self.provider == "zai":
                from hermes.channels.cli.auth import _resolve_zai_base_url
            ...
            try:
                from hermes.channels.cli.runtime_provider import _get_named_custom_provider
            except ImportError:
                return False
        ...
        from hermes.channels.cli.route_identity import normalize_route_base_url
    ...
    def _try_refresh_vertex_client_credentials(self) -> bool:
        ...
        try:
            from hermes.agent.vertex_adapter import get_vertex_config
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from hermes.channels.cli.copilot_auth import (
    ...
    def _try_refresh_anthropic_client_credentials(self) -> bool:
        ...
        try:
            from hermes.agent.anthropic_adapter import resolve_anthropic_token, build_anthropic_client
        ...
        from hermes.agent.anthropic_adapter import _is_oauth_token
    ...
    def _apply_client_headers_for_base_url(
        ...
        *,
        ...
        from hermes.agent.auxiliary_client import (
            _AI_GATEWAY_HEADERS,
        ...
        if base_url_host_matches(base_url, "openrouter.ai"):
            ...
            from hermes.channels.cli.models import copilot_default_headers
            ...
            from hermes.agent.auxiliary_client import _codex_cloudflare_headers
            self._client_kwargs["default_headers"] = _codex_cloudflare_headers(
                self._client_kwargs.get("api_key", "")
            )
        elif base_url_host_matches(base_url, "x.ai"):
            # Cover both provider=xai and provider=xai-oauth (api.x.ai).
            from hermes.tools.xai_http import hermes_xai_default_headers
            ...
            _ph_headers = None
            try:
                from hermes.integrations.providers import get_provider_profile as _gpf2
    ...
    def _swap_credential(self, entry) -> None:
        ...
        if self.api_mode == "anthropic_messages":
            from hermes.agent.anthropic_adapter import build_anthropic_client, _is_oauth_token
    ...
    def _recover_with_credential_pool(
        ...
        *,
        ...
        from hermes.agent.agent_runtime_helpers import recover_with_credential_pool
    ...
    def _anthropic_messages_create(self, api_kwargs: dict, *, client: Any = None):
        ...
        from hermes.agent.anthropic_adapter import create_anthropic_message
    ...
    def _interruptible_api_call(self, api_kwargs: dict):
        ...
        from hermes.agent.chat_completion_helpers import interruptible_api_call
    ...
    def _interruptible_streaming_api_call(
        ...
        from hermes.agent.chat_completion_helpers import interruptible_streaming_api_call
        return interruptible_streaming_api_call(self, api_kwargs, on_first_delta=on_first_delta)

    def _try_activate_fallback(self, reason: "FailoverReason | None" = None) -> bool:
        """Forwarder — see ``agent.chat_completion_helpers.try_activate_fallback``."""
        from hermes.agent.chat_completion_helpers import try_activate_fallback
    ...
    def _restore_primary_runtime(self) -> bool:
        ...
        from hermes.agent.agent_runtime_helpers import restore_primary_runtime
    ...
    def _try_recover_primary_transport(
        ...
        from hermes.agent.agent_runtime_helpers import try_recover_primary_transport
    ...
    def _model_supports_vision(self) -> bool:
        ...
        try:
            ...
            from hermes.agent.image_routing import _lookup_supports_vision
            cfg = load_config()
    ...
    def _provider_supports_vision_tool_messages(self) -> bool:
        ...
        """
        try:
            from hermes.integrations.providers import get_provider_profile
            provider = (getattr(self, "provider", "") or "").strip()
    ...
    def _get_transport(self, api_mode: str = None):
        ...
        t = cache.get(mode)
        if t is None:
            from hermes.agent.transports import get_transport
    ...
    def _try_shrink_image_parts_in_messages(
        ...
        *,
        ...
        from hermes.agent.conversation_compression import try_shrink_image_parts_in_messages
    ...
    def _build_api_kwargs(self, api_messages: list, tools_for_api: Optional[list] = None) -> dict:
        ...
        from hermes.agent.chat_completion_helpers import build_api_kwargs
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from hermes.channels.cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from hermes.channels.cli.models import lmstudio_model_reasoning_options
    ...
    def _ollama_supports_thinking_cached(self) -> bool:
        ...
        try:
            from hermes.channels.cli.models import ollama_model_supports_thinking
    ...
    def _resolve_lmstudio_summary_reasoning_effort(self) -> Optional[str]:
        ...
        """
        from hermes.agent.lmstudio_reasoning import resolve_lmstudio_effort
    ...
    def _build_assistant_message(self, assistant_message, finish_reason: str) -> dict:
        ...
        from hermes.agent.chat_completion_helpers import build_assistant_message
    ...
    def _needs_kimi_tool_reasoning(self) -> bool:
        ...
        """
        from hermes.agent.message_sanitization import matches_reasoning_echo_family
    ...
    def _copy_reasoning_content_for_api(self, source_msg: dict, api_msg: dict) -> None:
        ...
        from hermes.agent.agent_runtime_helpers import copy_reasoning_content_for_api
    ...
    def _reapply_reasoning_echo_for_provider(self, api_messages: list) -> int:
        ...
        from hermes.agent.agent_runtime_helpers import reapply_reasoning_echo_for_provider
    ...
    def _sanitize_tool_calls_for_strict_api(api_msg: dict, model: "str | None" = None) -> dict:
        ...
        if not isinstance(tool_calls, list):
            return api_msg
        from hermes.agent.transports.chat_completions import _model_consumes_thought_signature
    ...
    def _sanitize_tool_call_arguments(
        ...
        *,
        ...
        from hermes.agent.agent_runtime_helpers import sanitize_tool_call_arguments
    ...
    def _compress_context(
        ...
        *,
        ...
        from hermes.agent.portal_tags import (
        ...
        try:
            ...
            try:
                from hermes.runtime.logging import set_session_context
    ...
    def _execute_tool_calls(self, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
        ...
        try:
            ...
            from hermes.agent.tool_dispatch_helpers import _plan_tool_batch_segments
            ...
            from hermes.agent.tool_executor import execute_tool_calls_segmented
    ...
    def _dispatch_delegate_task(self, function_args: dict) -> str:
        ...
        """
        from hermes.tools.delegate_tool import (
    ...
    def _invoke_tool(self, function_name: str, function_args: dict, effective_task_id: str,
        ...
        from hermes.agent.agent_runtime_helpers import invoke_tool
        return invoke_tool(
            self,
            function_name,
            function_args,
    ...
    def _execute_tool_calls_concurrent(self, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
        ...
        from hermes.agent.tool_executor import execute_tool_calls_concurrent
    ...
    def _execute_tool_calls_sequential(self, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
        ...
        from hermes.agent.tool_executor import execute_tool_calls_sequential
    ...
    def _handle_max_iterations(self, messages: list, api_call_count: int) -> str:
        ...
        from hermes.agent.chat_completion_helpers import handle_max_iterations
    ...
    def run_conversation(
        ...
        from hermes.agent.aux_accounting import (
            reset_accounting_context,
            set_accounting_context,
        )
        from hermes.agent import relay_runtime
        from hermes.agent.conversation_loop import run_conversation
        from hermes.agent.portal_tags import (
            reset_conversation_context,
            set_conversation_context,
        )
        from hermes.channels.cli.observability.relay_shared_metrics import (
            finish_task_run,
            start_task_run,
        )
        from hermes.agent.subagent_lifecycle import bind_subagent_parent
        ...
        try:
            ...
            from hermes.agent.auxiliary_client import scoped_runtime_main
    ...
    def _run_codex_app_server_turn(
        ...
        *,
        ...
        from hermes.agent.codex_runtime import run_codex_app_server_turn
...
def main(
    ...
    # Handle tool listing
    if list_tools:
        from hermes.agent.model_tools import get_all_tool_names, get_available_toolsets
        from hermes.tools.toolsets import get_all_toolsets, get_toolset_info
    ...
    with principal_scope(build_local_cli_principal(agent.session_id)):
