...
from hermes.agent.memory_manager import build_memory_context_block
...
def build_turn_context(
    ...
    *,
    ...
    try:
        from hermes.agent.auxiliary_client import set_runtime_main
        set_runtime_main(
    ...
    try:
        if not getattr(agent, "_skip_mcp_refresh", False):
            ...
            if "tools.mcp_tool" in _sys.modules:
                from hermes.tools.mcp_tool import has_registered_mcp_tools, refresh_agent_mcp_tools
    ...
    from hermes.agent.agent_runtime_helpers import note_turn_start
    ...
    if reaction_callback is not None:
        try:
            from hermes.agent.reactions import detect_reaction
    ...
    try:
        ...
        try:
            from hermes.tools.hook_output_spill import (
