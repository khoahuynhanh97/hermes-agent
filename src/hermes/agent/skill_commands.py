...
from hermes.agent.skill_preprocessing import (
...
def _load_skill_payload(skill_identifier: str, task_id: str | None = None) -> tuple[dict[str, Any], Path | None, str] | None:
    ...
    try:
        from hermes.tools.skills_tool import SKILLS_DIR, skill_view
...
def scan_skill_commands() -> Dict[str, Dict[str, Any]]:
    ...
    _skill_commands = {}
    try:
        from hermes.tools.skills_tool import SKILLS_DIR, _parse_frontmatter, skill_matches_platform, skill_matches_environment, _get_disabled_skill_names
        from hermes.agent.skill_utils import get_external_skills_dirs, iter_skill_index_files
