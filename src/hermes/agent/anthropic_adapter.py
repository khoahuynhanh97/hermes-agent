...
from hermes.runtime.utils import base_url_host_matches, base_url_hostname, normalize_proxy_env_vars
...
def _build_anthropic_client_with_bearer_hook(
    ...
    *,
    ...
    from hermes.agent.azure_identity_adapter import build_bearer_http_client
...
def _resolve_anthropic_pool_token() -> Optional[str]:
    ...
    """
    try:
        from hermes.agent.credential_pool import AUTH_TYPE_OAUTH, load_pool
    except Exception:
        return None
...
def run_hermes_oauth_login_pure() -> Optional[Dict[str, Any]]:
    ...
    try:
        from hermes.channels.cli.auth import _can_open_graphical_browser as _can_open_gui
    except Exception:
...
def _is_stream_unavailable_error(exc: Exception) -> bool:
    ...
    if "invokemodelwithresponsestream" in err_lower:
        from hermes.agent.bedrock_adapter import is_streaming_access_denied_error
