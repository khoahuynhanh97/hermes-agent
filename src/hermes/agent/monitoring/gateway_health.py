...
from hermes.agent.monitoring.events import GatewayDiagnosticEvent, GatewayHealthEvent
...
def _derive_busy(gateway_running: bool, gateway_state: Any, active_agents: Any) -> bool:
    try:
        from hermes.channels.gateway.status import derive_gateway_busy
...
def _derive_drainable(gateway_running: bool, gateway_state: Any) -> bool:
    try:
        from hermes.channels.gateway.status import derive_gateway_drainable
