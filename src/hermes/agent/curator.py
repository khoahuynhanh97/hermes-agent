...
def _cron_referenced_skills() -> Set[str]:
    ...
    """
    try:
        from hermes.scheduling.jobs import referenced_skill_names as _refs
        return _refs()
    except Exception as e:
...
def apply_automatic_transitions(now: Optional[datetime] = None) -> Dict[str, int]:
    ...
    """
    from hermes.tools import skill_usage as _u
    ...
    *,
    ...
    try:
        ...
        if consolidated_map or pruned_names:
            from hermes.scheduling.jobs import rewrite_skill_refs as _rewrite_cron_refs
...
def run_curator_review(
    ...
    *consolidate*: when consolidation is off, the preview only reports the
    ...
    if dry_run:
        ...
        try:
            from hermes.agent import curator_backup
