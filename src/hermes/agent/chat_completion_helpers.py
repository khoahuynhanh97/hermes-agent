...
from hermes.channels.cli.timeouts import get_provider_request_timeout, get_provider_stale_timeout
from hermes.runtime.constants import PARTIAL_STREAM_STUB_ID, FINISH_REASON_LENGTH
from hermes.agent.error_classifier import FailoverReason
from hermes.agent.errors import EmptyStreamError
from hermes.agent.turn_context import substitute_api_content
from hermes.agent.gemini_native_adapter import is_native_gemini_base_url
from hermes.agent.model_metadata import is_local_endpoint
from hermes.agent.message_content import flatten_message_text
from hermes.agent.message_sanitization import (
    _sanitize_surrogates,
    _repair_tool_call_arguments,
)
from hermes.agent.stream_single_writer import claim_stream_writer, stream_writer_is_current
from hermes.tools.terminal_tool import is_persistent_env
from hermes.runtime.utils import base_url_host_matches, base_url_hostname, env_float, env_int
...
def interruptible_api_call(agent, api_kwargs: dict):
    ...
    request_client_lock = threading.Lock()
    # Request-local cancellation flag. Distinct from hermes.agent._interrupt_requested
...
def build_api_kwargs(agent, api_messages: list, tools_for_api: list | None = None) -> dict:
    ...
    try:
        from hermes.agent.auxiliary_client import _fixed_temperature_for_model, OMIT_TEMPERATURE
...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    from hermes.agent.backend_identity import BackendIdentity, should_skip_candidate
    ...
    try:
        ...
        if fb_api_mode == "anthropic_messages":
            ...
            from hermes.agent.anthropic_adapter import build_anthropic_client, resolve_anthropic_token, _is_oauth_token
            ...
            # causing 403s from hermes.integrations.providers like Kimi Coding that
...
def handle_max_iterations(agent, messages: list, api_call_count: int) -> str:
    ...
    try:
        ...
        summary_extra_body = {}
        try:
            from hermes.agent.auxiliary_client import _fixed_temperature_for_model, OMIT_TEMPERATURE as _OMIT_TEMP
        except Exception:
        ...
        if _is_nous:
            from hermes.agent.portal_tags import nous_portal_tags as _portal_tags
...
def cleanup_task_resources(agent, task_id: str) -> None:
    ...
    try:
        headed = False
        try:
            from hermes.tools.browser_tool import _is_headed_mode
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    if agent.api_mode == "bedrock_converse":
        ...
        while t.is_alive():
            ...
            if _stale_elapsed > _bedrock_stale_timeout:
                ...
                try:
                    from hermes.agent.bedrock_adapter import invalidate_runtime_client
    ...
    def _call_anthropic(request_client):
        ...
        from hermes.agent import relay_llm
        from hermes.agent.anthropic_adapter import sanitize_anthropic_kwargs
    ...
    if result["error"] is not None:
        if deltas_were_sent["yes"]:
            ...
            try:
                from hermes.agent.error_classifier import classify_api_error, FailoverReason
