...
from hermes.channels.cli.config import load_env
from hermes.agent.secret_scope import get_secret as _get_secret
from hermes.agent.credential_persistence import (
    is_borrowed_credential_source,
    sanitize_borrowed_credential_payload,
)
import hermes.channels.cli.auth as auth_mod
    ...
    def _refresh_entry_impl(
        ...
        try:
            if self.provider == "anthropic":
                from hermes.agent.anthropic_adapter import refresh_anthropic_oauth_pure
                ...
                if entry.source == "claude_code":
                    try:
                        from hermes.agent.anthropic_adapter import _write_claude_code_credentials
...
def _seed_from_singletons(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
        from hermes.channels.cli.auth import is_source_suppressed as _is_suppressed
    except ImportError:
    ...
    if provider == "anthropic":
        ...
        from hermes.agent.anthropic_adapter import read_claude_code_credentials, read_hermes_oauth_credentials
        ...
        try:
            from hermes.channels.cli.auth import resolve_qwen_runtime_credentials
        ...
        if isinstance(tokens, dict) and tokens.get("access_token"):
            ...
            from hermes.channels.cli.auth import DEFAULT_XAI_OAUTH_BASE_URL
...
def _seed_from_env(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
        from hermes.channels.cli.auth import is_source_suppressed as _is_source_suppressed
    except ImportError:
