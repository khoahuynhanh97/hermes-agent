...
def finalize_turn(
    ...
    *,
    ...
    """
    from hermes.agent.conversation_loop import logger
    ...
    try:
        ...
        if interrupted:
            from hermes.agent.message_sanitization import close_interrupted_tool_sequence
    ...
    try:
        from hermes.agent.conversation_loop import _notify_context_engine_turn_complete
