...
from hermes.agent.lsp import eventlog
from hermes.agent.lsp.client import (
    DIAGNOSTICS_DOCUMENT_WAIT,
    LSPClient,
)
from hermes.agent.lsp.servers import (
    ServerContext,
    find_server_for_file,
    language_id_for,
)
from hermes.agent.lsp.workspace import (
    clear_cache,
        ...
        if delta:
            ...
            if baseline:
                if line_shift is not None:
                    ...
                    from hermes.agent.lsp.range_shift import shift_baseline
