...
from hermes.agent.prompt_builder import (
...
from hermes.agent.runtime_cwd import resolve_context_cwd
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if "computer_use" in agent.valid_tool_names:
        from hermes.agent.prompt_builder import computer_use_guidance
    ...
    if has_skills_tools:
        ...
        try:
            from hermes.agent.coding_context import coding_compact_skill_categories
    ...
    if agent.valid_tool_names:
        try:
            from hermes.agent.coding_context import coding_system_prompt_parts
    ...
    if getattr(agent, "_environment_probe", True):
        try:
            from hermes.tools.env_probe import get_environment_probe_line
