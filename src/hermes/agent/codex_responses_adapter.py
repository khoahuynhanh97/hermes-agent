...
from hermes.agent.message_sanitization import deterministic_call_id
from hermes.agent.prompt_builder import DEFAULT_AGENT_IDENTITY
...
def _preflight_codex_api_kwargs(
    ...
    *,
    ...
    if is_xai_model and normalized.get("tools"):
        try:
            from hermes.tools.schema_sanitizer import strip_slash_enum
