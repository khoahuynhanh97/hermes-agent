...
from hermes.agent.transports.base import ProviderTransport
from hermes.agent.transports.types import NormalizedResponse, ToolCall
...
def _xai_prefers_native_web_search() -> bool:
    ...
    """
    try:
        from hermes.agent.web_search_registry import get_active_search_provider

        provider = get_active_search_provider()
        if provider is not None:
            return getattr(provider, "name", None) == "xai"

        from hermes.tools.web_tools import _get_search_backend
...
def _default_prompt_cache_retention_for_request(
    ...
    from hermes.runtime.utils import base_url_hostname
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def _resolve_issuer_kind(self, params: Dict[str, Any]) -> str:
        ...
        from hermes.agent.codex_responses_adapter import _classify_responses_issuer
    ...
    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        ...
        from hermes.agent.codex_responses_adapter import _responses_tools
    ...
    def build_kwargs(
        ...
        **params,
        ...
        from hermes.agent.runtime_agent import DEFAULT_AGENT_IDENTITY
        ...
        if reasoning_enabled and is_xai_responses:
            from hermes.agent.model_metadata import grok_supports_reasoning_effort
    ...
    def preflight_kwargs(
        ...
        *,
        ...
        """
        from hermes.agent.codex_responses_adapter import _preflight_codex_api_kwargs
...
from hermes.agent.transports import register_transport  # noqa: E402
