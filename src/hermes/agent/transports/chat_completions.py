...
from hermes.agent.moonshot_schema import is_moonshot_model, sanitize_moonshot_tools
from hermes.agent.prompt_builder import DEVELOPER_ROLE_MODELS
from hermes.agent.transports.base import ProviderTransport
from hermes.agent.transports.types import NormalizedResponse, ToolCall, Usage
...
def _add_prompt_cache_key(
    ...
    *,
    ...
    from hermes.agent.transports.codex import _cache_scope_from_session_id, _content_cache_key
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        """
        from hermes.integrations.providers.base import OMIT_TEMPERATURE
