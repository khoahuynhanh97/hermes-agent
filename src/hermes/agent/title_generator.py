...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from hermes.agent code paths where a module-level hermes_cli import risks
...
def _auto_title_session(
    ...
    from hermes.agent.aux_accounting import set_accounting_context
    from hermes.agent.portal_tags import set_conversation_context
