...
from hermes.runtime.constants import get_hermes_home, get_skills_dir, is_wsl
...
from hermes.tools.threat_patterns import scan_for_threats as _scan_for_threats
...
def _probe_remote_backend(env_type: str) -> str | None:
    ...
    try:
        ...
        from hermes.tools.terminal_tool import _create_environment, _get_env_config  # type: ignore
...
def load_soul_md(context_length: Optional[int] = None) -> Optional[str]:
    ...
    """
    try:
        from hermes.channels.cli.config import ensure_hermes_home
        ensure_hermes_home()
    except Exception as e:
...
def build_context_files_prompt(
    ...
    from hermes.agent.runtime_cwd import _is_install_tree
