...
from hermes.agent.auxiliary_client import AuxiliaryExplicitCancellation
from hermes.agent.context_engine import (
    automatic_compaction_status_message,
    sanitize_memory_context,
)
from hermes.agent.model_metadata import estimate_request_tokens_rough
from hermes.agent.session_activity import ActivityProvenance, normalize_activity_provenance
...
def _cached_prompt_reflects_builtin_memory(agent: Any, cached_prompt: str) -> bool:
    ...
    if snapshot is None:
        return False
    try:
        from hermes.tools.memory_tool import MEMORY_BLOCK_HEADERS
    except Exception:
        return False
    ...
    *after* construction, so :func:`replay_compression_warning` re-sends
    ...
    try:
        ...
        if aux_context < threshold:
            ...
            from hermes.agent.context_compressor import ContextCompressor as _CC
...
def _strip_stale_todo_snapshot(content: Any) -> Any:
    ...
    """
    from hermes.tools.todo_tool import TODO_INJECTION_HEADER
    ...
    *,
    ...
    try:
        ...
        if todo_snapshot:
            ...
            from hermes.agent.context_compressor import _append_text_to_content
        ...
        if agent._session_db:
            ...
            try:
                ...
                if in_place:
                    ...
                    try:
                        from hermes.channels.cli.goals import migrate_goal_to_session
        ...
        try:
            from hermes.tools.file_tools import reset_file_dedup
        ...
        try:
            from hermes.tools.skills_tool import reset_skill_view_dedup
...
def _compress_context_via_codex_app_server(
    ...
    *,
    ...
    try:
        from hermes.agent.codex_runtime import (
...
def try_shrink_image_parts_in_messages(
    ...
    *,
    ...
    try:
        from hermes.tools.vision_tools import _resize_image_for_vision
    except Exception as exc:
