...
class FailoverReason(enum.Enum):
    ...
    llama_cpp_grammar_pattern = "llama_cpp_grammar_pattern"  # llama.cpp json-schema-to-grammar rejects regex escapes in `pattern` / `format` — strip from hermes.tools and retry
...
def classify_api_error(
    ...
    *,
    ...
    from hermes.agent.errors import MoAPresetNotFoundError
