...
def _moa_privacy_mode(moa_raw: Any) -> str:
    ...
    from hermes.channels.cli.moa_config import coerce_privacy_filter
...
def _maybe_apply_moa_cache_control(
    ...
    *,
    ...
    try:
        ...
        from hermes.agent.prompt_caching import apply_anthropic_cache_control
...
def _run_reference(
    ...
    *,
    ...
    """
    from hermes.agent.usage_pricing import CanonicalUsage, estimate_usage_cost, normalize_usage
    ...
    try:
        ...
        from hermes.agent.auxiliary_client import _normalize_aux_provider
...
def _run_references_parallel(
    ...
    *,
    ...
    """
    from hermes.agent.usage_pricing import CanonicalUsage
...
class MoAChatCompletions:
    ...
    def consume_and_save_trace(
        ...
        if not pending or "aggregator_input_messages" not in pending:
            return
        try:
            from hermes.agent.moa_trace import save_moa_turn
    ...
    def create(self, **api_kwargs: Any) -> Any:
        ...
        from hermes.channels.cli.config import get_config_path, load_config
