...
from hermes.runtime.utils import safe_json_loads
from hermes.agent.redact import redact_sensitive_text
from hermes.agent.tool_result_classification import file_mutation_result_landed
...
def _resolve_skill_manage_paths(args: dict) -> list[Path]:
    ...
    from hermes.tools.skill_manager_tool import _find_skill, _resolve_skill_dir
