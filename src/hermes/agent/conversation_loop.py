...
from hermes.agent.context_engine import automatic_compaction_status_message
from hermes.agent.display import KawaiiSpinner
from hermes.agent.error_classifier import FailoverReason, classify_api_error
from hermes.agent.turn_context import (
    _compression_warrants_another_preflight_pass,
    build_turn_context,
    compose_user_api_content,
    reanchor_current_turn_user_idx,
)
from hermes.agent.turn_retry_state import TurnRetryState
from hermes.agent.runtime_cwd import resolve_agent_cwd
from hermes.agent.message_sanitization import (
...
from hermes.agent.retry_utils import (
    adaptive_rate_limit_backoff,
    is_zai_coding_overload_error,
    jittered_backoff,
    zai_coding_overload_retry_ceiling,
)
from hermes.agent.trajectory import has_incomplete_scratchpad
from hermes.agent.usage_pricing import estimate_usage_cost, normalize_usage
from hermes.runtime.constants import PARTIAL_STREAM_STUB_ID
from hermes.runtime.logging import set_session_context
from hermes.tools.skill_provenance import set_current_write_origin
from hermes.runtime.utils import base_url_host_matches, env_var_enabled
...
def _billing_or_entitlement_message(
    *,
    ...
    try:
        from hermes.agent.billing_links import build_billing_block
...
def _restore_or_build_system_prompt(agent, system_message, conversation_history):
    ...
    if stored_prompt and _stored_prompt_matches_runtime(agent, stored_prompt):
        ...
        from hermes.agent.system_prompt import reconstruct_static_prefix
...
def _peel_moa_guidance(
    ...
    """
    from hermes.agent.moa_loop import peel_reference_guidance
...
def _apply_context_engine_selection(
    ...
    *,
    ...
    try:
        from hermes.agent.context_engine import ContextEngine as _CE
...
def run_conversation(
    ...
    if moa_config is None:
        try:
            from hermes.channels.cli.moa_config import decode_moa_turn
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        from hermes.agent.agent_runtime_helpers import repair_message_sequence_with_cursor
        ...
        if moa_config:
            try:
                from hermes.agent.message_content import flatten_message_text as _flatten_mt
                from hermes.agent.moa_loop import _preset_temperature, aggregate_moa_context
        ...
        while retry_count < max_retries:
            ...
            if agent.provider == "nous":
                try:
                    from hermes.agent.nous_rate_guard import (
            ...
            try:
                ...
                try:
                    from hermes.channels.cli.middleware import apply_llm_request_middleware
                ...
                try:
                    from hermes.channels.cli.lifecycle import (
                        has_hook,
                ...
                from hermes.channels.cli.middleware import run_llm_execution_middleware
                ...
                if agent.provider == "nous":
                    try:
                        from hermes.agent.nous_rate_guard import clear_nous_rate_limit
                ...
                if (
                    ...
                    from hermes.runtime.constants import display_hermes_home as _dhh_fn
                    _dhh = _dhh_fn()
                    _body_text = ""
                    try:
                ...
                if (
                    ...
                    try:
                        from hermes.tools.schema_sanitizer import strip_pattern_and_format
                ...
                if getattr(api_error, "status_code", None) == 404:
                    try:
                        from hermes.channels.cli.model_normalize import suggest_prefixed_model_id
                ...
                if retry_count >= max_retries:
                    ...
                    from hermes.agent.thinking_timeout_guidance import (
                        is_thinking_timeout,
                    )
        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                from hermes.agent.agent_runtime_helpers import (
                ...
                try:
                    from hermes.agent.verification_stop import (
                ...
                try:
                    from hermes.agent.verify_hooks import max_verify_nudges
                    from hermes.channels.cli.lifecycle import has_hook
                    from hermes.channels.cli.plugins import get_pre_verify_continue_message

                    if _edited and has_hook("pre_verify") and _attempt < max_verify_nudges():
                        # Posture is fixed for the session — resolve once + cache.
                        coding = getattr(agent, "_resolved_is_coding", None)
                        if coding is None:
                            from hermes.agent.coding_context import is_coding_context
                ...
                try:
                    from hermes.agent.kanban_stop import build_kanban_stop_nudge
    ...
    from hermes.agent.turn_finalizer import finalize_turn
