...
from hermes.tools.terminal_tool import (
    get_active_env,
)
from hermes.tools.thread_context import propagate_context_to_thread
from hermes.tools.tool_result_storage import (
    maybe_persist_tool_result,
    enforce_turn_budget,
)
from hermes.tools.budget_config import BudgetConfig, DEFAULT_BUDGET, budget_for_context_window
...
def _ensure_file_checkpoint(
    ...
    from hermes.tools.file_tools import _resolve_path_for_task
...
def _tool_search_scoped_names(agent) -> frozenset:
    ...
    try:
        ...
        from hermes.tools import tool_search as _ts
...
def _run_agent_tool_execution_middleware(
    ...
    *,
    ...
    from hermes.agent import relay_tools
    from hermes.channels.cli.middleware import (
...
def _begin_tool_execution(
    ...
    *,
    ...
    try:
        from hermes.tools.environments.base import set_activity_callback
...
def execute_tool_calls_sequential(agent, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0, *, finalize: bool = True) -> None:
    ...
    for i, tool_call in enumerate(assistant_message.tool_calls, 1):
        ...
        from hermes.agent.agent_runtime_helpers import agent_runtime_owns_post_tool_hook
