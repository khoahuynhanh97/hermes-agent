"""Config / projects / setup JSON-RPC handlers (moved verbatim from hermes.channels.api.py).
...
def _(rid, params: dict) -> dict:
    ...
    if key == "provider":
        try:
            from hermes.channels.cli.models import list_available_providers, normalize_provider
...
def _(rid, params: dict) -> dict:
    try:
        from hermes.channels.cli.main import _has_any_provider_configured
