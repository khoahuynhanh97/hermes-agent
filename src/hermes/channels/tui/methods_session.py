"""Session / delegation / spawn-tree / billing / pet JSON-RPC handlers (moved verbatim from hermes.channels.api.py).
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from hermes.agent.coding_context import project_facts_for
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from hermes.agent.verification_evidence import verification_status
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from hermes.agent.oneshot import run_oneshot
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from hermes.agent.pet import constants, render, store
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        seen: set[str] = set()
        try:
            from hermes.agent.pet.manifest import fetch_manifest, prefetch
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from hermes.agent.pet import store
        from hermes.channels.cli.pets import _clear_active_if
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        if new_slug != slug:
            try:
                from hermes.channels.cli.pets import _rename_active_if
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from hermes.channels.cli.pets import _set_enabled
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from hermes.channels.cli.pets import set_pet_scale
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from hermes.agent.pet.generate.imagegen import (
            GenerationError,
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from hermes.agent.pet.generate import generate_base_drafts
        from hermes.agent.pet.generate.imagegen import GenerationError, resolve_provider
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from hermes.agent.pet import store
        from hermes.agent.pet.generate import hatch_pet
        from hermes.agent.pet.generate.imagegen import GenerationError, resolve_provider
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from hermes.agent.billing_view import build_billing_state
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from hermes.agent.subscription_view import build_subscription_state
...
def _(rid, params: dict) -> dict:
    ...
    """
    from hermes.agent.subscription_view import subscription_change_preview_from_payload
    from hermes.channels.cli.nous_billing import BillingError, post_subscription_preview
...
def _(rid, params: dict) -> dict:
    ...
    billing:manage.
    """
    from hermes.channels.cli.nous_billing import BillingError, put_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    """
    from hermes.channels.cli.nous_billing import BillingError, delete_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    """
    from hermes.agent.billing_view import new_idempotency_key
    from hermes.channels.cli.nous_billing import BillingError, post_subscription_upgrade
...
def _(rid, params: dict) -> dict:
    ...
    """
    from hermes.channels.cli.nous_billing import BillingError, post_charge
    from hermes.agent.billing_view import new_idempotency_key
...
def _(rid, params: dict) -> dict:
    ...
    """
    from hermes.channels.cli.nous_billing import BillingError, get_charge_status
...
def _(rid, params: dict) -> dict:
    ...
    """
    from hermes.channels.cli.nous_billing import BillingError, patch_auto_top_up
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from hermes.channels.cli.auth import step_up_nous_billing_scope
        from hermes.channels.cli.nous_billing import BillingError
...
def _(rid, params: dict) -> dict:
    from hermes.tools.delegate_tool import set_spawn_paused
...
def _(rid, params: dict) -> dict:
    from hermes.tools.delegate_tool import interrupt_subagent
