"""Completion / model-key / paste JSON-RPC handlers (moved verbatim from hermes.channels.api.py).
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from hermes.channels.cli.commands import SlashCommandCompleter
        from prompt_toolkit.document import Document
        from prompt_toolkit.formatted_text import to_plain_text

        from hermes.agent.skill_commands import get_skill_commands
        from hermes.agent.skill_bundles import get_skill_bundles
...
def _(rid, params: dict) -> dict:
    try:
        from hermes.channels.cli.inventory import build_model_options_payload
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from hermes.channels.cli.config import is_managed
        from hermes.channels.cli.inventory import build_models_payload
...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from hermes.channels.cli.auth import PROVIDER_REGISTRY, clear_provider_auth
