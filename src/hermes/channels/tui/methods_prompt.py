"""Prompt / attachment / respond JSON-RPC handlers (moved verbatim from hermes.channels.api.py).
...
def _(rid, params: dict) -> dict:
    from hermes.channels.cli.input_sanitize import sanitize_user_prompt_text
...
def _(rid, params: dict) -> dict:
    ...
    if err:
        return err
    try:
        from hermes.channels.cli.clipboard import has_clipboard_image, save_clipboard_image
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            try:
                from hermes.tools.terminal_tool import clear_task_env_overrides
