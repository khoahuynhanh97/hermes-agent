...
class ComputeHost:
    ...
    def _ensure_server_session(self, server: Any, frame: dict[str, Any]) -> dict:
        ...
        try:
            if profile_home:
                from hermes.runtime.constants import set_hermes_home_override
            ...
            if home_token is not None:
                try:
                    from hermes.runtime.constants import reset_hermes_home_override
                    ...
                    pass
        try:
            from hermes.channels.tui.transport import bind_transport, reset_transport
    ...
    def _handle_control(self, frame: dict[str, Any]) -> None:
        ...
        try:
            from hermes.channels.tui import server
            from hermes.channels.tui.host_supervisor import MUTATOR_ROUTE_TABLE
            ...
            if route_name in {"session.compress", "slash.compress"}:
                ...
                try:
                    from hermes.channels.tui import server as _server
