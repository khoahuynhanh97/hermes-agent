...
def _run_check() -> None:
    ...
    from hermes.channels.acp.server import HermesACPAgent  # noqa: F401

    print("Hermes ACP check OK")


def _run_setup() -> None:
    from hermes.channels.cli.main import main as hermes_main
...
def main(argv: list[str] | None = None) -> None:
    ...
    # Ensure the project root is on sys.path so ``from hermes.agent.runtime_agent import AIAgent`` works
