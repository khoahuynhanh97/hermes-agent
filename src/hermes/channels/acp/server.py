...
from hermes.channels.acp.auth import TERMINAL_SETUP_AUTH_METHOD_ID, build_auth_methods, detect_provider
from hermes.channels.acp.events import (
...
from hermes.channels.acp.permissions import make_approval_callback
from hermes.channels.acp.provenance import session_provenance_meta
from hermes.channels.acp.session import SessionManager, SessionState, _expand_acp_enabled_toolsets
from hermes.channels.acp.tools import build_tool_complete, build_tool_start
from hermes.agent.context_compressor import (
...
try:
    from hermes.channels.cli import __version__ as HERMES_VERSION
except Exception:
...
class HermesACPAgent(acp.Agent):
    ...
    def _build_model_state(self, state: SessionState) -> SessionModelState | None:
        ...
        try:
            ...
            from hermes.channels.cli.models import normalize_provider, provider_label
    ...
    def _resolve_model_selection(raw_model: str, current_provider: str) -> tuple[str, str]:
        ...
        try:
            from hermes.channels.cli.models import detect_provider_for_model, parse_model_input
    ...
    async def _register_session_mcp_servers(
        ...
        try:
            from hermes.tools.mcp_tool import register_mcp_servers
        ...
        try:
            ...
            from hermes.agent.memory_manager import inject_memory_provider_tools
    ...
    def _schedule_mcp_late_refresh(self, state: SessionState) -> None:
        ...
        """
        try:
            from hermes.channels.cli.mcp_startup import mcp_discovery_in_flight
        except Exception:
            return
        ...
        def _wait_then_refresh() -> None:
            try:
                from hermes.channels.cli.mcp_startup import join_mcp_discovery
    ...
    async def prompt(
        ...
        **kwargs: Any,
        ...
        if conn:
            ...
            try:
                from hermes.channels.acp.edit_approval import make_acp_edit_approval_requester
        ...
        def _run_agent() -> dict:
            ...
            if approval_cb:
                try:
                    from hermes.tools import terminal_tool as _terminal_tool
            ...
            if edit_approval_requester:
                try:
                    from hermes.channels.acp.edit_approval import set_edit_approval_requester
            ...
            try:
                ...
                if edit_approval_token is not None:
                    try:
                        from hermes.channels.acp.edit_approval import reset_edit_approval_requester
    ...
    def _handle_slash_command(self, text: str, state: SessionState) -> str | None:
        ...
        def _dispatch() -> str | None:
            try:
                from hermes.agent.runtime_cwd import set_session_cwd
