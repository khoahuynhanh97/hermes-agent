...
def _provider_base_url(provider: str) -> str:
    ...
    if provider.startswith(CUSTOM_POOL_PREFIX):
        from hermes.agent.credential_pool import _get_custom_provider_config
...
def auth_add_command(args) -> None:
    ...
    if provider == "anthropic":
        from hermes.agent import anthropic_adapter as anthropic_mod
...
def _interactive_auth() -> None:
    ...
    try:
        from hermes.agent.bedrock_adapter import has_aws_credentials, resolve_aws_auth_env_var, resolve_bedrock_region
