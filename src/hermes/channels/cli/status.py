...
from hermes.channels.cli.auth import AuthError, resolve_provider
from hermes.channels.cli.colors import Colors, color
from hermes.channels.cli.config import get_env_path, get_env_value, get_hermes_home, load_config
from hermes.channels.cli.models import provider_label
...
from hermes.channels.cli.runtime_provider import resolve_requested_provider
...
def _format_relative_ts(ts: float) -> str:
    ...
    from hermes.channels.cli.timefmt import relative_time
...
def show_status(args):
    ...
    if _effective_provider_label() == "LM Studio":
        from hermes.channels.cli.models import probe_lmstudio_models
        model_cfg = config.get("model")
    ...
    try:
        from hermes.channels.cli.gateway import get_gateway_runtime_snapshot, _format_gateway_pids
    ...
    try:
        from hermes.channels.cli.active_sessions import (
