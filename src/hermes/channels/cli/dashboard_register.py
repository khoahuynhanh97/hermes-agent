...
def _resolve_portal_base_url(override: Optional[str] = None) -> str:
    ...
    try:
        from hermes.channels.cli.auth import DEFAULT_NOUS_PORTAL_URL, get_provider_auth_state
...
def cmd_dashboard_register(args) -> None:
    ...
    from hermes.channels.cli.auth import AuthError, resolve_nous_access_token
    from hermes.channels.cli.config import get_env_value, is_managed, save_env_value
