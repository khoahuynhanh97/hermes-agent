...
def _prompt_plugin_env_vars(manifest: dict, console) -> None:
    ...
    from hermes.channels.cli.config import get_env_value, save_env_value  # noqa: F811
...
def _discover_entrypoint_plugins() -> list[tuple[str, str, str, str]]:
    ...
    """
    from hermes.channels.cli.plugins import ENTRY_POINTS_GROUP
...
def _discover_context_engines() -> list[tuple[str, str]]:
    ...
    try:
        from hermes.integrations.plugins.context_engine import discover_context_engines
    ...
    try:
        from hermes.channels.cli.plugins import discover_plugins, get_plugin_context_engine
        discover_plugins()
