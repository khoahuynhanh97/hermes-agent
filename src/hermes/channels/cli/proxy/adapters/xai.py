...
from hermes.agent.credential_pool import CredentialPool, PooledCredential, load_pool
from hermes.channels.cli.auth import DEFAULT_XAI_OAUTH_BASE_URL
from hermes.channels.cli.proxy.adapters.base import UpstreamAdapter, UpstreamCredential
