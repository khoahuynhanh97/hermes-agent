...
from hermes.channels.cli.proxy.adapters.base import UpstreamAdapter
from hermes.channels.cli.proxy.adapters.nous_portal import NousPortalAdapter
from hermes.channels.cli.proxy.adapters.xai import XAIGrokAdapter
