...
in main.py re-imports them (``from hermes.channels.cli.model_setup_flows import *``-style
...
imported lazily inside the flows (``from hermes.channels.cli.main import ...`` resolves at
...
from hermes.channels.cli.config import clear_model_endpoint_credentials
from hermes.channels.cli.providers import custom_provider_slug
...
def _existing_api_key_for_model_flow(provider_id: str, pconfig) -> tuple[str, str]:
    ...
    from hermes.channels.cli.auth import _resolve_api_key_provider_secret
...
def _prune_replaced_custom_model_config_credentials(
    ...
    *,
    ...
    try:
        ...
        from hermes.channels.cli.auth import read_credential_pool, write_credential_pool
...
def _prompt_auth_credentials_choice(title: str) -> str:
    ...
    try:
        from hermes.channels.cli.setup import _curses_prompt_choice
...
def _model_flow_openrouter(config, current_model=""):
    ...
    from hermes.channels.cli.main import _prompt_api_key
    ...
    from hermes.channels.cli.models import model_ids, get_pricing_for_provider
...
def _model_flow_ai_gateway(config, current_model=""):
    ...
    from hermes.runtime.constants import AI_GATEWAY_BASE_URL
    from hermes.channels.cli.main import _prompt_api_key
    from hermes.channels.cli.auth import (
        PROVIDER_REGISTRY,
        _prompt_model_selection,
    ...
    from hermes.channels.cli.models import ai_gateway_model_ids, get_pricing_for_provider
...
def _model_flow_moa(config, current_model=""):
    ...
    """
    from hermes.channels.cli.auth import _save_model_choice, deactivate_provider
    from hermes.channels.cli.config import load_config, save_config
...
def _model_flow_nous(config, current_model="", args=None):
    ...
    from hermes.channels.cli.nous_subscription import prompt_enable_tool_gateway
    ...
    if free_tier:
        try:
            from hermes.channels.cli.nous_account import (
    ...
    if free_tier and not model_ids:
        ...
        if unavailable_models:
            from hermes.channels.cli.auth import DEFAULT_NOUS_PORTAL_URL
...
def _model_flow_xai_oauth(_config, current_model="", *, args=None):
    ...
    from hermes.channels.cli.models import _PROVIDER_MODELS
...
def _model_flow_qwen_oauth(_config, current_model=""):
    ...
    from hermes.channels.cli.main import _DEFAULT_QWEN_PORTAL_MODELS
    from hermes.channels.cli.auth import (
    ...
    from hermes.channels.cli.models import fetch_api_models
...
def _model_flow_custom(config):
    ...
    """
    from hermes.channels.cli.main import _auto_provider_name, _prompt_custom_api_mode_selection, _save_custom_provider
    from hermes.channels.cli.auth import _save_model_choice, deactivate_provider
    from hermes.channels.cli.config import (
    ...
    from hermes.channels.cli.secret_prompt import masked_secret_prompt
    ...
    from hermes.channels.cli.models import probe_api_models
...
def _model_flow_azure_foundry(config, current_model=""):
    ...
    * Manual entry when every probe fails (private endpoints, etc.).
    ...
    """
    from hermes.channels.cli.auth import _save_model_choice, deactivate_provider  # noqa: F401
    from hermes.channels.cli.config import (
        get_env_value,
        save_env_value,
        load_config,
    ...
    from hermes.channels.cli import azure_detect
...
def _model_flow_named_custom(config, provider_info):
    ...
    """
    from hermes.channels.cli.main import _custom_provider_api_key_config_value, _custom_provider_base_url_config_value, _save_custom_provider
    from hermes.channels.cli.auth import _save_model_choice, deactivate_provider
    from hermes.channels.cli.config import load_config, save_config
    from hermes.channels.cli.models import fetch_api_models
    ...
    if models:
        ...
        try:
            from hermes.channels.cli.curses_ui import curses_radiolist
...
def _model_flow_copilot(config, current_model=""):
    ...
    from hermes.channels.cli.main import _current_reasoning_effort, _prompt_reasoning_effort_selection, _set_reasoning_effort
    from hermes.channels.cli.auth import (
        PROVIDER_REGISTRY,
        _prompt_model_selection,
        _save_model_choice,
    ...
    from hermes.channels.cli.config import save_env_value, load_config, save_config
    from hermes.channels.cli.models import (
        _PROVIDER_MODELS,
        fetch_api_models,
    ...
    if not api_key:
        ...
        if choice == "1":
            try:
                from hermes.channels.cli.copilot_auth import copilot_device_code_login
            ...
            # Validate token type
            try:
                from hermes.channels.cli.copilot_auth import validate_copilot_token
...
def _model_flow_stepfun(config, current_model=""):
    ...
    from hermes.channels.cli.main import _infer_stepfun_region, _prompt_api_key, _prompt_provider_choice, _stepfun_base_url_for_region
    from hermes.channels.cli.auth import (
        PROVIDER_REGISTRY,
        _prompt_model_selection,
        _save_model_choice,
    ...
    from hermes.channels.cli.models import _PROVIDER_MODELS, fetch_api_models
...
def _model_flow_bedrock_api_key(config, region, current_model=""):
    ...
    from hermes.channels.cli.auth import _resolve_api_key_provider_secret, ProviderConfig
...
def _model_flow_vertex(config, current_model=""):
    ...
    *path* lives in .env (VERTEX_CREDENTIALS_PATH / GOOGLE_APPLICATION_CREDENTIALS);
    ...
    from hermes.channels.cli.config import load_config, save_config, get_env_value
    from hermes.channels.cli.models import _PROVIDER_MODELS
...
def _select_zai_endpoint(current_base: str) -> str:
    ...
    or error.
    """
    from hermes.channels.cli.main import _prompt_provider_choice
    from hermes.channels.cli.auth import ZAI_ENDPOINTS
...
def _model_flow_api_key_provider(config, provider_id, current_model=""):
    ...
    if provider_id == "gemini" and existing_key:
        try:
            from hermes.agent.gemini_native_adapter import probe_gemini_tier
        except Exception:
    ...
    if provider_id == "lmstudio":
        ...
        from hermes.channels.cli.models import fetch_lmstudio_models
        ...
        from hermes.channels.cli.models import fetch_ollama_cloud_models
        ...
        if live_models:
            ...
            mdev_models: list = []
            try:
                from hermes.agent.models_dev import list_agentic_models
    ...
    if model_list:
        ...
        pricing: dict = {}
        try:
            from hermes.channels.cli.models import get_pricing_for_provider
...
def _model_flow_anthropic(config, current_model=""):
    ...
    from hermes.channels.cli.main import _run_anthropic_oauth_flow
    from hermes.channels.cli.auth import (
        _prompt_model_selection,
        _save_model_choice,
        deactivate_provider,
