...
def _palette() -> dict[str, str]:
    from hermes.agent.learning_graph_render import derive_palette

    return derive_palette(_primary_hex(), dark=True)


def _fade(base: Optional[str], alpha: float) -> Optional[str]:
    from hermes.agent.learning_graph_render import hex_to_rgb, mix_rgb, rgb_to_hex
...
def _frame_renderable(payload, *, cols, rows, reveal, color):
    ...
    from hermes.agent import learning_graph_render as render
...
def _cmd_list(args: argparse.Namespace) -> int:
    from hermes.agent.learning_graph_render import format_date
...
def _cmd_delete(args: argparse.Namespace) -> int:
    from hermes.agent.learning_mutations import delete_node, node_detail
...
def _cmd_edit(args: argparse.Namespace) -> int:
    from hermes.agent.learning_mutations import edit_node, node_detail
