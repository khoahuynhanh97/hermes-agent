...
from hermes.channels.cli import auth as auth_mod
...
from hermes.channels.cli.providers import custom_provider_aliases, custom_provider_slug
...
from hermes.runtime.utils import base_url_host_matches, base_url_hostname, env_int
...
def _config_base_url_trustworthy_for_bare_custom(cfg_base_url: str, cfg_provider: str) -> bool:
    ...
    try:
        from hermes.channels.cli.auth import resolve_provider as _resolve_provider
...
def _copilot_runtime_api_mode(
    ...
    *,
    ...
    try:
        from hermes.channels.cli.models import copilot_model_api_mode
    ...
    *,
    ...
    if provider == "openai-codex":
        ...
        if effective_model and api_mode != "anthropic_messages":
            try:
                from hermes.channels.cli.models import azure_foundry_model_api_mode
        ...
        if provider in {"opencode-zen", "opencode-go"}:
            ...
            # Refs #16878.
            from hermes.channels.cli.models import opencode_model_api_mode
...
def _resolve_explicit_runtime(
    *,
    ...
    if provider == "anthropic":
        ...
        api_key = explicit_api_key
        if not api_key:
            from hermes.agent.anthropic_adapter import resolve_anthropic_token
...
def resolve_runtime_provider(
    *,
    ...
    from hermes.channels.cli.config import is_provider_enabled, load_config
    ...
    if provider == "minimax-oauth":
        ...
        if pconfig and pconfig.auth_type == "oauth_minimax":
            from hermes.channels.cli.auth import resolve_minimax_oauth_runtime_credentials
