...
Import discipline mirrors ``hermes_cli.cli_commands_mixin``:
  ...
  * cli.py-internal symbols (the ``_cprint``/``_b``/``_d`` helpers and
    ...
    ``from hermes.channels.cli.classic_runtime import ...``. The mixin never imports ``cli`` at module load
...
class CLIBillingMixin:
    ...
    def _print_nous_credits_block(self) -> bool:
        ...
        """
        from hermes.channels.cli.classic_runtime import _cprint, _b, _d

        try:
            from hermes.agent.billing_usage import build_usage_model, format_renews
    ...
    def _print_usage_cta(self) -> None:
        ...
        """
        from hermes.channels.cli.classic_runtime import _cprint, _d
    ...
    def _show_subscription(self):
        ...
        from hermes.agent.subscription_view import build_subscription_state, subscription_manage_url
    ...
    def _open_url_in_browser(self, url: str) -> bool:
        ...
        if not url:
            return False
        try:
            from hermes.channels.cli.auth import _can_open_graphical_browser, _is_remote_session
    ...
    def _subscription_free_catalog(self, state, manage_url):
        ...
        from hermes.agent.subscription_view import (
            format_tier_row,
            selectable_tiers,
    ...
    def _subscription_pick_tier(self, state):
        ...
        from hermes.agent.subscription_view import format_tier_row, is_upgrade, selectable_tiers
    ...
    def _subscription_preview_and_confirm(self, state, tier_id, *, allow_stepup=True):
        ...
        from hermes.channels.cli.nous_billing import BillingError, BillingScopeRequired, post_subscription_preview
        ...
        if effect not in ("charge_now", "scheduled"):
            ...
            from hermes.agent.subscription_view import is_upgrade, subscription_manage_url
    ...
    def _subscription_apply(self, state, action, idempotency_key=None, *, allow_stepup=True):
        ...
        """
        from hermes.channels.cli.classic_runtime import _cprint, _d, _DIM, _RST
    ...
    def _subscription_handle_scope_required(self, state, *, retry, idempotency_key=None):
        ...
        try:
            from hermes.channels.cli import nous_billing as _nb
    ...
    def _billing_add_card_flow(self, state):
        ...
        """
        from hermes.channels.cli.classic_runtime import _cprint, _b, _d, _DIM, _RST
    ...
    def _billing_buy_flow(self, state):
        ...
        from hermes.channels.cli.classic_runtime import _cprint, _b

        from hermes.agent.billing_view import format_money, validate_charge_amount
    ...
    def _billing_confirm_and_charge(self, state, amount):
        ...
        from hermes.agent.billing_view import format_money, new_idempotency_key
    ...
    def _billing_poll_charge(self, state, charge_id, amount):
        ...
        while _time.time() < deadline:
            ...
            if state_str == "settled":
                ...
                from hermes.agent.billing_view import parse_money
