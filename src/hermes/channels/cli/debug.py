...
def _primary_log_path(log_name: str) -> Optional[Path]:
    ...
    from hermes.channels.cli.logs import LOG_FILES
...
def _capture_dump() -> str:
    ...
    from hermes.channels.cli.dump import run_dump
...
def _run_debug_share_nous(args, *, log_lines: int, redact: bool) -> None:
    ...
    suggests ``--local``.
    """
    from hermes.channels.cli.diagnostics_upload import share_to_nous
