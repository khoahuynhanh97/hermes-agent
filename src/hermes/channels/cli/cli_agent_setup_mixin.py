...
method (``from hermes.channels.cli.classic_runtime import ...`` resolves at call time, when ``cli`` is fully
...
class CLIAgentSetupMixin:
    ...
    def _ensure_runtime_credentials(self) -> bool:
        ...
        """
        from hermes.channels.cli.classic_runtime import ChatConsole, _cprint, logger
    ...
    def _offer_first_run_setup(self) -> bool:
        ...
        was configured.
        """
        from hermes.channels.cli.classic_runtime import _cprint, logger
    ...
    def _init_agent(self, *, model_override: str = None, runtime_override: dict = None, request_overrides: dict | None = None) -> bool:
        ...
        """
        from hermes.channels.cli.classic_runtime import AIAgent, ChatConsole, _DIM, _RST, _accent_hex, _cprint, _prepare_deferred_agent_startup, logger
        ...
        from hermes.channels.cli.mcp_startup import ensure_mcp_discovery_before_agent_build
        ...
        try:
            ...
            import hermes.channels.cli.classic_runtime as _cli
            ...
            from hermes.runtime.constants import partial_update_hint
    ...
    def _preload_resumed_session(self) -> bool:
        ...
        """
        from hermes.channels.cli.classic_runtime import _accent_hex
    ...
    def _display_resumed_history(self):
        ...
        """
        from hermes.channels.cli.classic_runtime import CLI_CONFIG, _record_output_history_entry, _strip_reasoning_tags, _suspend_output_history
        from hermes.tools.ansi_strip import sanitize_display_text as _sanitize_display_text
