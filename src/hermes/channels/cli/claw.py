...
from hermes.channels.cli.config import get_hermes_home, get_config_path, load_config, save_config
...
def _warn_if_gateway_running(auto_yes: bool) -> None:
    ...
    """
    from hermes.channels.gateway.status import get_running_pid, read_runtime_status
...
def _cmd_migrate(args):
    ...
    if not no_backup:
        try:
            from hermes.channels.cli.backup import create_pre_migration_backup, _format_size
