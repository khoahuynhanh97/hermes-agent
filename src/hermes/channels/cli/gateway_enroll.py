...
def _resolve_identity_token() -> str:
    ...
    """
    from hermes.channels.gateway.relay import _resolve_relay_identity_token
...
def cmd_gateway_enroll(args) -> None:
    ...
    from hermes.channels.cli.config import is_managed, save_env_value
    ...
    from hermes.channels.cli.config import get_env_path
