...
def build_models_payload(
    ...
    *,
    ...
    """
    from hermes.channels.cli.model_switch import list_authenticated_providers
    ...
    try:
        from hermes.channels.cli.providers import is_routing_aggregator as _is_routing_aggregator
    except Exception:
...
def _apply_featured(rows: list[dict]) -> None:
    ...
    """
    try:
        from hermes.agent.models_dev import get_model_info
    except Exception:
...
def _append_unconfigured_rows(
    ...
    *,
    ...
    from hermes.channels.cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
...
def _reorder_canonical(rows: list[dict]) -> list[dict]:
    ...
    """
    from hermes.channels.cli.models import CANONICAL_PROVIDERS
