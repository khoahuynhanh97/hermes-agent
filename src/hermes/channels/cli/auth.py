...
from hermes.runtime.constants import OPENROUTER_BASE_URL, secure_parent_dir
from hermes.agent.credential_persistence import sanitize_borrowed_credential_payload
from hermes.runtime.utils import atomic_replace, atomic_yaml_write, env_float, is_truthy_value
...
try:  # Version tag for the Codex token-endpoint User-Agent; fall back if unavailable.
    from hermes.channels.cli import __version__ as _HERMES_CLI_VERSION
...
try:
    from hermes.integrations.providers import list_providers as _list_providers_for_registry
...
def get_anthropic_key() -> str:
    ...
    """
    from hermes.channels.cli.config import get_env_value_prefer_dotenv
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
            from hermes.channels.cli.copilot_auth import resolve_copilot_token, get_copilot_api_token
...
def _parse_retry_after_seconds(headers: Any) -> Optional[int]:
    ...
    """
    from hermes.agent.retry_utils import parse_retry_after_seconds
...
def resolve_provider(
    ...
    *,
    ...
    try:
        from hermes.integrations.providers import list_providers as _lp
        for _pp in _lp():
            for _alias in _pp.aliases:
    ...
    try:
        from hermes.agent.credential_pool import load_pool as _load_pool
...
def _get_azure_foundry_auth_status() -> Dict[str, Any]:
    ...
    try:
        from hermes.channels.cli.config import load_config, get_env_value_prefer_dotenv
        cfg = load_config()
    except Exception:
        cfg = {}
...
def _prompt_model_selection(
    ...
    try:
        ...
        from hermes.channels.cli.model_search import model_search_text
    ...
    from hermes.channels.cli.curses_ui import format_radio_item_ansi
...
def _save_model_choice(model_id: str) -> None:
    ...
    """
    from hermes.channels.cli.config import save_config, load_config
