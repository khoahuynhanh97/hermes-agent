...
from hermes.runtime.utils import atomic_write_text, atomic_yaml_write
...
def import_agent_command(args) -> None:
    """Handle ``hermes import-agent`` (invoked from hermes.channels.cli.main)."""
    from hermes.channels.cli.config import get_config_path, load_config, save_config
...
def print_import_report(report: Dict[str, Any], dry_run: bool) -> None:
    ...
    from hermes.channels.cli.setup import Colors, color, print_header, print_info
