...
from hermes.runtime.constants import get_default_hermes_root, get_hermes_home, display_hermes_home
...
def _collect_memory_provider_external_paths() -> List[Path]:
    ...
    """
    try:
        from hermes.integrations.plugins.memory import _get_active_memory_provider, load_memory_provider
    except Exception:
        return []
