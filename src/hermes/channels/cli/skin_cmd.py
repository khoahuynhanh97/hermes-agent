...
from hermes.runtime.constants import display_hermes_home, get_hermes_home
...
def _use(name: str) -> None:
    ...
    from hermes.channels.cli.config import config_command
...
def _skin_set(key: str, value: str, skin: str | None) -> int:
    ...
    if path.exists():
        ...
        from hermes.channels.cli.skin_engine import load_skin
