...
def _get_available_providers() -> list:
    """Discover memory providers from hermes.integrations.plugins/memory/.

    Returns list of (name, description, provider_instance) tuples.
    """
    try:
        from hermes.integrations.plugins.memory import discover_memory_providers, load_memory_provider
