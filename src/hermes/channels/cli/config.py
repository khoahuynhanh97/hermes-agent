...
from hermes.channels.cli.default_soul import DEFAULT_SOUL_MD, is_legacy_template_soul
...
from hermes.runtime.constants import get_hermes_home, get_process_hermes_home  # noqa: F811,E402
from hermes.runtime.utils import atomic_replace, fast_safe_load
...
from hermes.channels.cli.config_defaults import DEFAULT_CONFIG, OPTIONAL_ENV_VARS  # noqa: F401
...
def get_missing_skill_config_vars() -> List[Dict[str, Any]]:
    ...
    """
    try:
        from hermes.agent.skill_utils import discover_all_skill_config_vars, SKILL_CONFIG_PREFIX
    except Exception:
        return []
...
def migrate_config(interactive: bool = True, quiet: bool = False) -> Dict[str, Any]:
    ...
    from hermes.channels.cli.config_migrations import (
    ...
    try:
        ...
        from hermes.channels.cli.toolset_validation import validate_platform_toolsets
    ...
    if missing_skill_config and interactive and not quiet:
        ...
        if answer in {"y", "yes"}:
            ...
            config = read_raw_config()
            try:
                from hermes.agent.skill_utils import SKILL_CONFIG_PREFIX
            except Exception:
...
def atomic_config_write(config_path: Path, data: Any, **kwargs: Any) -> None:
    ...
    """
    from hermes.runtime.utils import atomic_yaml_write
...
def redact_key(key: str) -> str:
    ...
    """
    from hermes.agent.redact import mask_secret
...
def show_config():
    ...
    # Skill config
    try:
        from hermes.agent.skill_utils import discover_all_skill_config_vars, resolve_skill_config_values
...
def _load_cron_jobs_for_config_warning() -> List[Dict[str, Any]]:
    ...
    """
    try:
        from hermes.scheduling.jobs import load_jobs
        return load_jobs()
    except Exception:
        return []
