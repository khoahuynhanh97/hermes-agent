...
def get_provider(name: str, *, allow_network: bool = True) -> Optional[ProviderDef]:
    ...
    try:
        from hermes.agent.models_dev import get_provider_info as _mdev_provider
...
def resolve_provider_full(
    ...
    if canonical != raw:
        try:
            from hermes.channels.cli.auth import PROVIDER_REGISTRY as _AUTH_PROVIDER_REGISTRY
