...
from hermes.channels.cli import __version__ as VERSION, __release_date__ as RELEASE_DATE
...
def check_for_updates() -> Optional[int]:
    ...
    try:
        from hermes.channels.cli.config import detect_install_method, get_project_root
...
def get_git_banner_state(repo_dir: Optional[Path] = None) -> Optional[dict]:
    ...
    if repo_dir is None:
        ...
        try:
            from hermes.channels.cli.build_info import get_build_sha
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    try:
        from hermes.channels.cli.codex_runtime_switch import get_current_runtime
    ...
    try:
        ...
        if behind is not None and behind != 0:
            from hermes.channels.cli.config import get_managed_update_command, recommended_update_command
            if behind > 0:
