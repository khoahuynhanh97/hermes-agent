...
def _m():
    ...
    at import time.
    """
    from hermes.channels.cli import main
...
def _validate_critical_modules_import(root) -> tuple[bool, str | None, str | None]:
    ...
    """
    from hermes.runtime.constants import FIRST_PARTY_MODULE_ROOTS
...
def _update_via_zip(args):
    ...
    from hermes.channels.cli.managed_uv import ensure_uv, update_managed_uv
    ...
    # Sync skills
    try:
        from hermes.tools.skills_sync import sync_skills
    ...
    try:
        from hermes.channels.cli.model_catalog import seed_cache_from_checkout
    ...
    try:
        from hermes.channels.cli.backup import _quick_snapshot_root, verify_sqlite_integrity
...
def _refresh_active_lazy_features(
    ...
    *,
    ...
    """
    try:
        from hermes.tools import lazy_deps
    except Exception as exc:
...
def _refresh_active_memory_provider_dependencies() -> None:
    ...
    try:
        from hermes.channels.cli.memory_setup import _install_dependencies
    except Exception as exc:
...
def _install_psutil_android_compat(
    ...
    *,
    ...
    from hermes.channels.cli.psutil_android import PSUTIL_URL, prepare_patched_psutil_sdist
...
def _ensure_uv_for_termux(pip_cmd: list[str]) -> str | None:
    ...
    """
    from hermes.channels.cli.managed_uv import resolve_uv
...
def _update_node_dependencies() -> list[str]:
    ...
    if not npm:
        ...
        from hermes.runtime.constants import is_wsl
    ...
    from hermes.runtime.constants import with_hermes_node_path
...
def _cmd_update_check(branch: str = "main", *, branch_explicit: bool = False):
    ...
    """
    from hermes.channels.cli.config import detect_install_method, recommended_update_command_for_method
    ...
    if method == "docker":
        ...
        from hermes.channels.cli.config import format_docker_update_message
...
def _run_pre_update_backup(args) -> Optional[str]:
    ...
    try:
        ...
        # NOTE: this function later does `from hermes.runtime.constants import
        # get_hermes_home`, which makes the name function-local — the
        # module-level import is shadowed and unbound here. Alias explicitly.
        from hermes.channels.cli.config import get_hermes_home as _get_home
    ...
    try:
        from hermes.channels.cli.backup import create_pre_update_backup
    except Exception as exc:
        print(
...
def _write_update_planned_stop_marker(profile_path: Path, pid: int) -> bool:
    ...
    try:
        ...
        from hermes.channels.gateway.status import _get_process_start_time
...
def _leftover_pausable_gateway_pids(
    ...
    """
    from hermes.channels.cli._scan_venv_blockers import _is_pausable_gateway
...
def _cold_start_windows_gateway_after_update() -> None:
    ...
    try:
        from hermes.channels.cli import gateway_windows
        from hermes.channels.cli.gateway import find_gateway_pids
    except Exception as exc:
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        try:
            from hermes.channels.cli.profiles import backfill_profile_envs
        ...
        try:
            from hermes.integrations.plugins.memory.honcho.cli import sync_honcho_profiles_quiet
        ...
        # it and warn loudly.
        try:
            from hermes.channels.cli.backup import restore_cron_jobs_if_emptied
        ...
        try:
            ...
            if (
                ...
                from hermes.channels.cli.tools_config import install_cua_driver
        ...
        try:
            ...
            try:
                from hermes.channels.cli.gateway import _get_restart_exit_wait_budget
            ...
            try:
                ...
                if _stuck:
                    ...
                    from hermes.channels.gateway.status import terminate_pid as _terminate_pid
                    for pid in _stuck:
                        try:
