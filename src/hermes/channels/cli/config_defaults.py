...
verbatim from hermes.channels.cli/config.py. Must not import from hermes.channels.cli.config.
"""
...
DEFAULT_CONFIG = {
    ...
    "dashboard": {
        ...
        # ``password_hash`` with
        # ``python -c "from hermes.integrations.plugins.dashboard_auth.basic import hash_password; print(hash_password('PW'))"``.
        "basic_auth": {
