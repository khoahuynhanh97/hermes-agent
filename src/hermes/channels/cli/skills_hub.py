...
def _resolve_short_name(name: str, sources, console: Console) -> str:
    ...
    """
    from hermes.tools.skills_hub import unified_search
...
def _existing_categories() -> List[str]:
    ...
    """
    from hermes.tools.skills_hub import SKILLS_DIR, _category_skill_dirs
    try:
...
def do_search(query: str, source: str = "all", limit: int = 10,
    ...
    """
    from hermes.tools.skills_hub import GitHubAuth, create_source_router, unified_search
...
def do_browse(page: int = 1, page_size: int = 20, source: str = "all",
    ...
    from hermes.tools.skills_hub import _PROVIDER_FILTER_VALUES, _filter_results_by_provider
...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    from hermes.tools.skills_guard import scan_skill_cached, should_allow_install, format_scan_report
    ...
    try:
        ...
        from hermes.tools.skills_hub import append_audit_log
    ...
    from hermes.tools.skills_hub import HUB_DIR, source_url_for_bundle
    ...
    try:
        ...
        append_audit_log("BLOCKED", bundle.name, bundle.source,
                         bundle.trust_level, "invalid_path", str(exc))
        return
    from hermes.tools.skills_hub import SKILLS_DIR
    ...
    try:
        from hermes.tools.blueprints import BlueprintError, blueprint_spec_for_installed, register_blueprint_suggestion
...
def do_inspect(identifier: str, console: Optional[Console] = None) -> None:
    ...
    from hermes.tools.skills_hub import GitHubAuth, create_source_router
...
def do_list(source_filter: str = "all",
    ...
    """
    from hermes.tools.skills_hub import HubLockFile, ensure_hub_dirs
    from hermes.tools.skills_sync import _read_manifest
    from hermes.tools.skills_tool import _find_all_skills
...
def do_check(name: Optional[str] = None, console: Optional[Console] = None) -> None:
    ...
    from hermes.tools.skills_hub import check_for_skill_updates
...
def do_update(name: Optional[str] = None, console: Optional[Console] = None) -> None:
    ...
    from hermes.tools.skills_hub import HubLockFile, check_for_skill_updates
...
def do_audit(name: Optional[str] = None, console: Optional[Console] = None,
    ...
    are unchanged).
    """
    from hermes.tools.skills_hub import HubLockFile, SKILLS_DIR
    from hermes.tools.skills_guard import scan_skill, format_scan_report
    ...
    if deep:
        from hermes.tools.skills_ast_audit import ast_scan_path, format_ast_report
...
def do_uninstall(name: str, console: Optional[Console] = None,
    ...
    from hermes.tools.skills_hub import uninstall_skill
...
def do_reset(name: str, restore: bool = False,
    ...
    from hermes.tools.skills_sync import reset_bundled_skill
...
def do_list_modified(console: Optional[Console] = None,
    ...
    from hermes.tools.skills_sync import list_user_modified_bundled_skills
...
def do_diff(name: str, console: Optional[Console] = None) -> None:
    ...
    from hermes.tools.skills_sync import diff_bundled_skill
...
def do_opt_out(remove: bool = False,
    ...
    never touched.
    """
    from hermes.tools.skills_sync import (
...
def do_repair_official(name: str, restore: bool = False,
    ...
    from hermes.tools.skills_sync import restore_official_optional_skill
...
def do_tap(action: str, repo: str = "", console: Optional[Console] = None) -> None:
    ...
    from hermes.tools.skills_hub import TapsManager
...
def do_publish(skill_path: str, target: str = "github", repo: str = "",
    ...
    from hermes.tools.skills_hub import GitHubAuth, SKILLS_DIR
    from hermes.tools.skills_guard import scan_skill, format_scan_report
...
def do_snapshot_export(output_path: str, console: Optional[Console] = None) -> None:
    ...
    from hermes.tools.skills_hub import HubLockFile, TapsManager
...
def skills_command(args) -> None:
    """Router for `hermes skills <subcommand>` — called from hermes.channels.cli/main.py."""
