...
from hermes.tools.ansi_strip import strip_ansi as _strip_ansi
...
def _status(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from hermes.channels.cli.status import show_status
...
def _doctor(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from hermes.channels.cli.doctor import run_doctor
...
def _logs(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from hermes.channels.cli.logs import list_logs, tail_log
...
def _config_show(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from hermes.channels.cli.config import show_config
...
def _config_set(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    key = args[0]
    value = " ".join(args[1:])
    from hermes.channels.cli.config import set_config_value
...
def _config_migrate(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    def _run() -> None:
        from hermes.channels.cli.config import migrate_config
...
def _sessions_repair(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    def _run() -> None:
        from hermes.state.service import DEFAULT_DB_PATH, _db_opens_cleanly, repair_state_db_schema
...
def _cron_list(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    ns = parser.parse_args(args)
    from hermes.channels.cli.cron import cron_list
...
def _cron_status(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from hermes.channels.cli.cron import cron_status
...
def _cron_pause(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from hermes.scheduling.jobs import AmbiguousJobReference, pause_job
...
def _cron_resume(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from hermes.scheduling.jobs import AmbiguousJobReference, resume_job
...
def _cron_run(_engine: HermesConsoleEngine, args: list[str]) -> str:
    ...
    from hermes.scheduling.jobs import AmbiguousJobReference, trigger_job
