...
def cmd_sessions(args, sessions_parser=None):
    ...
    if action == "repair":
        from hermes.state.service import (
            DEFAULT_DB_PATH,
            _db_opens_cleanly,
    ...
    if action == "recover":
        ...
        from hermes.channels.cli.session_recovery import (
    ...
    if action == "list":
        from hermes.state.service import workspace_key as _ws_key
        ...
        from hermes.channels.cli.session_filters import (
            build_prune_filters,
            describe_filters,
        )
        ...
        def _redact(data):
            if not args.redact or data is None:
                return data
            from hermes.channels.cli.session_export_md import redact_session_data
        ...
        if getattr(args, "only", None):
            if args.format not in ("jsonl", "md"):
                ...
                return
            from hermes.channels.cli.session_export import (
                export_record_count,
        ...
        if args.format == "html":
            if not args.output or args.output == "-":
                ...
                return
            from hermes.channels.cli.session_export_html import (
        ...
        if args.format == "trace":
            ...
            from hermes.agent.trace_upload import (
                TraceRedactionError,
                build_trace_jsonl,
        ...
        # Markdown / QMD export
        from hermes.channels.cli.session_export_md import (
        ...
        from hermes.agent.title_generator import generate_title
