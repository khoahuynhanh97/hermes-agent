...
from hermes.agent.models_dev import (
    ModelCapabilities,
    ModelInfo,
...
def _ensure_direct_aliases() -> None:
    ...
    the module attribute. This keeps `from hermes.channels.cli.model_switch import
...
def switch_model(
    ...
    if explicit_provider:
        ...
        from hermes.channels.cli.models import _AGGREGATOR_PROVIDERS as _AGG_PROVIDERS
        from hermes.channels.cli.providers import ALIASES as _PROVIDER_ALIAS_TABLE
    ...
    # =================================================================
        ...
        try:
            from hermes.channels.cli.config import load_config
            from hermes.channels.cli.moa_config import exact_moa_preset_name, normalize_moa_config
    ...
    if provider_changed or explicit_provider:
        ...
        if explicit_provider and user_providers:
            from hermes.channels.cli.providers import resolve_user_provider as _ruser
    ...
    if target_provider in {"opencode-zen", "opencode-go"} and isinstance(base_url, str):
        from hermes.channels.cli.models import normalize_opencode_base_url
...
def _extra_headers_from_config(entry: Any) -> dict[str, str]:
    if not isinstance(entry, dict):
        return {}
    from hermes.channels.cli.config import normalize_extra_headers
...
def list_authenticated_providers(
    ...
    *,
    ...
    Uses the curated model lists from hermes.channels.cli/models.py (OPENROUTER_MODELS,
    ...
    def _record_builtin_endpoint(slug: str) -> None:
        ...
        try:
            from hermes.channels.cli.auth import PROVIDER_REGISTRY as _reg
        except Exception:
            return
        pcfg = _reg.get(slug)
        if not pcfg:
    ...
    def _has_aws_sdk_creds_for_listing(slug: str) -> bool:
        ...
        if slug_norm != current_norm:
            return False
        try:
            from hermes.agent.bedrock_adapter import has_aws_credentials
    ...
    for hermes_id, mdev_id in PROVIDER_TO_MODELS_DEV.items():
        ...
        try:
            from hermes.integrations.providers import get_provider_profile as _gpp
        ...
        from hermes.channels.cli.auth import is_runtime_provider_routable
        ...
        if not has_creds:
            try:
                from hermes.channels.cli.auth import _load_auth_store
    ...
    from hermes.channels.cli.providers import HERMES_OVERLAYS
    from hermes.channels.cli.auth import PROVIDER_REGISTRY as _auth_registry
    ...
    for pid, overlay in HERMES_OVERLAYS.items():
        ...
        if overlay.auth_type == "aws_sdk":
            ...
            # fully configured.
            try:
                from hermes.agent.vertex_adapter import has_vertex_credentials
        ...
        # reflects the active region (eu.*, ap.*) not the static us.* list.
            ...
            try:
                ...
                from hermes.channels.cli.auth import get_provider_auth_state as _nous_state
    ...
    # with `hermes model`).
    try:
        from hermes.channels.cli.models import CANONICAL_PROVIDERS as _canon_provs
    except ImportError:
        _canon_provs = []
...
def _prepend_moa_picker_provider(providers: List[dict], current_provider: str = "") -> List[dict]:
    ...
    """
    try:
        from hermes.channels.cli.inventory import _moa_provider_row
...
def list_picker_providers(
    ...
    """
    from hermes.channels.cli.models import fetch_openrouter_models
