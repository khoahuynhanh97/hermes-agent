...
def _exec_version(ctx: CommandContext) -> CommandReply:
    ...
    from hermes.channels.cli.banner import format_banner_version_label
...
def _exec_bundles(ctx: CommandContext) -> CommandReply:
    ...
    try:
        from hermes.agent.skill_bundles import _bundles_dir, list_bundles
...
def _exec_help(ctx: CommandContext) -> CommandReply:
    ...
    from hermes.channels.cli.commands import gateway_help_lines
