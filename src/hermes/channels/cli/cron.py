...
from hermes.scheduling.lifecycle_guard import (  # noqa: F401  (re-exported for terminal_tool)
...
def cron_list(show_all: bool = False):
    ...
    from hermes.scheduling.jobs import list_jobs
...
def cron_tick():
    ...
    from hermes.scheduling.scheduler import tick
    tick(verbose=True)


def cron_runs(job_id: Optional[str] = None, limit: int = 20):
    """Show indexed durable cron execution history."""
    from hermes.scheduling.executions import list_executions
...
def cron_edit(args):
    from hermes.scheduling.jobs import AmbiguousJobReference, resolve_job_ref
