...
from hermes.runtime.utils import env_var_enabled, fast_safe_load
from hermes.channels.cli.config import cfg_get
from hermes.channels.cli.middleware import OBSERVER_SCHEMA_VERSION, VALID_MIDDLEWARE
...
def get_bundled_plugins_dir() -> Path:
    ...
    """
    canonical = Path(__file__).resolve().parents[2] / "integrations" / "plugins"
    if canonical.exists():
        return canonical
    return Path(__file__).resolve().parents[3] / "resources" / "plugins"
...
class PluginContext:
    ...
    def llm(self) -> Any:
        ...
        if self._llm is None:
            from hermes.agent.plugin_llm import PluginLlm
    ...
    def subagent_lifecycle(self) -> Any:
        ...
        if self._subagent_lifecycle is None:
            from hermes.agent.subagent_lifecycle import (
    ...
    def register_context_engine(self, engine) -> None:
        ...
        from hermes.agent.context_engine import ContextEngine
    ...
    def register_image_gen_provider(self, provider) -> None:
        ...
        tool calls.
        """
        from hermes.agent.image_gen_provider import ImageGenProvider
        from hermes.agent.image_gen_registry import register_provider
    ...
    def register_video_gen_provider(self, provider) -> None:
        ...
        tool calls.
        """
        from hermes.agent.video_gen_provider import VideoGenProvider
        from hermes.agent.video_gen_registry import register_provider as _register_video_provider
    ...
    def register_web_search_provider(self, provider) -> None:
        ...
        tool calls.
        """
        from hermes.agent.web_search_provider import WebSearchProvider
        from hermes.agent.web_search_registry import register_provider as _register_web_provider
    ...
    def register_browser_provider(self, provider) -> None:
        ...
        """
        from hermes.agent.browser_provider import BrowserProvider
        from hermes.agent.browser_registry import register_provider as _register_browser_provider
    ...
    def register_secret_source(self, source) -> None:
        ...
        """
        from hermes.agent.secret_sources.base import SecretSource
        from hermes.agent.secret_sources.registry import register_source
    ...
    def register_tts_provider(self, provider) -> None:
        ...
        """
        from hermes.agent.tts_provider import TTSProvider
        from hermes.agent.tts_registry import register_provider as _register_tts_provider
    ...
    def register_transcription_provider(self, provider) -> None:
        ...
        **but only when**:
        ...
        backends).
        """
        from hermes.agent.transcription_provider import TranscriptionProvider
        from hermes.agent.transcription_registry import register_provider as _register_stt_provider
    ...
    def register_platform(
        ...
        **entry_kwargs: Any,
        ...
        """
        from hermes.channels.gateway.platform_registry import platform_registry, PlatformEntry
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        from hermes.channels.cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
    ...
    def register_skill(
        ...
        """
        from hermes.agent.skill_utils import _NAMESPACE_RE
...
class PluginManager:
    ...
    def _load_plugin(self, manifest: PluginManifest) -> None:
        ...
        from hermes.tools.registry import registry as _registry
...
def _get_pre_tool_call_directive_details(
    ...
    from hermes.channels.cli.lifecycle import invoke_hook as invoke_lifecycle_hook
