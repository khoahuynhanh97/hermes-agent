...
from hermes.channels.cli import kanban_swarm as ks
...
def _check_dispatcher_presence(
    ...
    """
    try:
        from hermes.channels.gateway.status import resolve_gateway_liveness  # type: ignore
    except Exception:
...
def _cmd_specify(args: argparse.Namespace) -> int:
    ...
    from hermes.channels.cli import kanban_specify as spec
...
def _cmd_decompose(args: argparse.Namespace) -> int:
    ...
    from hermes.channels.cli import kanban_decompose as decomp
