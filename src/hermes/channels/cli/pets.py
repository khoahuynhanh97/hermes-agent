...
def _cmd_list(args) -> int:
    ...
    from hermes.agent.pet.manifest import ManifestError, fetch_manifest
...
def _cmd_show(args) -> int:
    ...
    from hermes.agent.pet import store
    from hermes.agent.pet.constants import DEFAULT_SCALE, LOOP_MS, STATE_ROWS, PetState, resolve_cols
    from hermes.agent.pet.render import build_renderer
...
def _cmd_doctor(args) -> int:
    ...
    from hermes.agent.pet import store
    from hermes.agent.pet.render import detect_terminal_graphics, resolve_mode
...
def set_pet_scale(value: float | str) -> tuple[float, str | None]:
    ...
    """
    from hermes.agent.pet.constants import clamp_scale
