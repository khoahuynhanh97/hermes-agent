...
from hermes.runtime.constants import get_hermes_home, get_optional_mcps_dir
...
from hermes.channels.cli.cli_output import prompt as _prompt_input
...
def _parse_manifest(path: Path) -> CatalogEntry:
    ...
    if t_type == "http" and a_type == "api_key":
        ...
        # at connect time.
        from hermes.channels.cli.mcp_config import _env_key_for_server
...
def _build_server_config(
    ...
    if t.type == "stdio":
        ...
        if entry.auth.type == "oauth":
            ...
            from hermes.channels.cli.mcp_config import _bearer_auth_headers
...
def _probe_tools(name: str) -> Optional[List[tuple]]:
    ...
    try:
        ...
        from hermes.channels.cli.mcp_config import _probe_single_server
...
def install_entry(entry: CatalogEntry, *, enable: bool = True) -> None:
    ...
    from hermes.channels.cli.mcp_config import _save_mcp_server
