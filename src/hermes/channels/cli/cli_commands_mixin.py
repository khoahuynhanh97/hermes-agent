...
Import discipline (mirrors gateway/slash_commands.py, PR #41886):
  ...
  * cli.py-internal symbols (the ``_cprint``/``_ACCENT``/``save_config_value``…
    ...
    via ``from hermes.channels.cli.classic_runtime import ...`` — that resolves at call time when ``cli`` is fully
...
from hermes.runtime.constants import display_hermes_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    lazy ``from hermes.channels.cli.classic_runtime import ...`` lines, so they compose cleanly onto
    ...
    def _handle_rollback_command(self, command: str):
        ...
        """
        from hermes.tools.checkpoint_manager import format_checkpoint_list
    ...
    def _print_diff_text(self, text: str) -> None:
        ...
        if console is not None:
            try:
                from hermes.channels.cli.classic_runtime import _rich_text_from_ansi
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        """
        from hermes.channels.cli.backup import (
    ...
    def _handle_export_command(self, command: str):
        ...
        """
        from hermes.channels.cli.profiles import export_profile, get_active_profile_name
    ...
    def _handle_import_command(self, command: str):
        ...
        """
        from hermes.channels.cli.profiles import (
    ...
    def _handle_stop_command(self):
        ...
        try:
            from hermes.tools.async_delegation import active_count, interrupt_all
    ...
    def _handle_agents_command(self):
        ...
        from hermes.channels.cli.classic_runtime import _cprint
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        ...
        from hermes.channels.cli.classic_runtime import _cprint
        from hermes.channels.cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        """
        from hermes.channels.cli.classic_runtime import _DIM, _RST, _cprint, _termux_example_image_path
        ...
        from hermes.channels.cli.clipboard import has_clipboard_image
    ...
    def _handle_copy_command(self, cmd_original: str) -> None:
        ...
        from hermes.channels.cli.classic_runtime import _assistant_copy_text, _cprint
        ...
        try:
            from hermes.channels.cli.clipboard import (
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        from hermes.channels.cli.classic_runtime import _DIM, _IMAGE_EXTENSIONS, _RST, _cprint, _resolve_attachment_path, _split_path_input, _termux_example_image_path
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        """
        from hermes.channels.cli.classic_runtime import _ACCENT, _DIM, _RST, _cprint
        import shlex
        from argparse import Namespace
        from contextlib import redirect_stdout
        from io import StringIO
        from hermes.channels.cli.tools_config import tools_disable_enable_command
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        if not pcfg or not pcfg.enabled:
            ...
            relay_fronts = False
            try:
                from hermes.channels.gateway.relay import relay_platform_identities
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        from hermes.channels.cli.classic_runtime import _cprint, _sync_process_session_id
        ...
        if target.isdigit():
            ...
            from hermes.channels.cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        """
        from hermes.agent.pet import store
        from hermes.agent.pet.manifest import ManifestError
        from hermes.channels.cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_hatch_command(self, cmd: str):
        ...
        """
        from hermes.agent.pet import store
        from hermes.agent.pet.generate import orchestrate
        from hermes.agent.pet.generate.imagegen import GenerationError
        from hermes.channels.cli.pets import _set_active
    ...
    def _handle_cron_command(self, cmd: str):
        ...
        from hermes.channels.cli.classic_runtime import get_job
        import shlex
        from hermes.tools.cronjob_tools import cronjob as cronjob_tool
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from hermes.channels.cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from hermes.channels.cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from hermes.channels.cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        ...
        from hermes.channels.cli.classic_runtime import ChatConsole
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from hermes.channels.cli.skills_hub import handle_skills_slash
    ...
    def _handle_learn_command(self, cmd: str):
        ...
        """
        from hermes.agent.learn_prompt import build_learn_prompt
    ...
    def _handle_init_command(self, cmd: str):
        ...
        """
        from hermes.channels.cli.init_command import build_init_prompt_for_cwd
    ...
    def _handle_background_command(self, cmd: str):
        ...
        """
        from hermes.channels.cli.classic_runtime import AIAgent, ChatConsole, _accent_hex, _cprint, _maybe_remap_for_light_mode, _render_final_assistant_content, set_approval_callback, set_secret_capture_callback, set_sudo_password_callback
        ...
        def run_background():
            ...
            try:
                ...
                with principal_scope(build_local_cli_principal(session_id=task_id)):
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        """
        from hermes.channels.cli.classic_runtime import ChatConsole, _BOLD, _DIM, _RST, _accent_hex, _cprint
        from hermes.channels.cli.slash_exec import CommandContext, execute_command
    ...
    def _handle_browser_command(self, cmd: str):
        ...
        if sub.startswith("connect"):
            ...
            try:
                from hermes.tools.browser_tool import _ensure_cdp_supervisor  # type: ignore[import-not-found]
            ...
            if current:
                ...
                try:
                    from hermes.tools.browser_tool import cleanup_all_browsers, _stop_cdp_supervisor
            ...
            if current:
                ...
                try:
                    from hermes.tools.browser_tool import _get_cloud_provider
                ...
                if provider is not None:
                    ...
                    try:
                        from hermes.tools.browser_tool import _get_browser_engine
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        from hermes.channels.cli.classic_runtime import _DIM, _RST, _cprint
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        from hermes.channels.cli.classic_runtime import _ACCENT, save_config_value
        try:
            from hermes.channels.cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_focus_command(self, cmd_original: str) -> None:
        ...
        """
        from hermes.channels.cli.classic_runtime import _cprint, save_config_value
    ...
    def _set_tool_progress_mode(self, mode: str) -> None:
        ...
        """
        from hermes.channels.cli.focus_view import normalize_tool_progress_mode
    ...
    def _note_focus_hidden_line(self, function_name: str) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from hermes.channels.cli.focus_view import would_display_tool_line
    ...
    def _emit_focus_recovery_line(self) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from hermes.channels.cli.focus_view import format_hidden_line
    ...
    def _handle_reasoning_command(self, cmd: str):
        ...
        """
        from hermes.channels.cli.classic_runtime import CLI_CONFIG, _ACCENT, _DIM, _RST, _cprint, _parse_reasoning_config, save_config_value
        parts = cmd.strip().split(maxsplit=1)
    ...
    def _handle_busy_command(self, cmd: str):
        ...
        """
        from hermes.channels.cli.classic_runtime import _ACCENT, _DIM, _RST, _cprint, save_config_value
        parts = cmd.strip().split(maxsplit=1)
    ...
    def _handle_indicator_command(self, cmd: str):
        ...
        """
        from hermes.channels.cli.classic_runtime import _ACCENT, _DIM, _RST, _cprint, save_config_value
        from hermes.runtime.constants import DEFAULT_INDICATOR_STYLE, INDICATOR_STYLES
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from hermes.channels.cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
    ...
    def _handle_debug_command(self, cmd_original: str = ""):
        ...
        """
        from hermes.channels.cli.debug import run_debug_share
    ...
    def _persist_wake_word_enabled(self, enabled: bool):
        ...
        from hermes.channels.cli.classic_runtime import _cprint, _DIM, _RST, save_config_value
