...
from hermes.channels.gateway.session_context import declare_stateless_channel
...
def _run_agent(
    ...
    from hermes.channels.cli.models import detect_provider_for_model
    ...
    if effective_provider is None and (model or env_model):
        ...
        if explicit_model:
            ...
            try:
                from hermes.channels.cli import model_switch as _ms
    ...
    try:
        ...
        from hermes.security.ingress import principal_scope, build_local_oneshot_principal
        with principal_scope(build_local_oneshot_principal(agent.session_id)):
