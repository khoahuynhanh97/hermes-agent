...
from hermes.runtime.constants import INDICATOR_STYLES
...
def _collect_gateway_skill_entries(
    ...
    try:
        ...
        from hermes.tools.skills_tool import SKILLS_DIR
        ...
        # silently excluded from hermes.channels.gateway slash menus (#8110).
...
class SlashCommandCompleter(Completer):
    ...
    def _stacked_skill_completions(self, text: str):
        ...
        """
        try:
            from hermes.agent.skill_commands import _MAX_STACKED_SKILLS as _cap
        except Exception:
            _cap = 5
    ...
    def _skin_completions(sub_text: str, sub_lower: str):
        ...
        try:
            from hermes.channels.cli.skin_engine import list_skins
            for s in list_skins():
                name = s["name"]
    ...
    def _personality_completions(sub_text: str, sub_lower: str):
        ...
        try:
            ...
            from hermes.channels.cli.classic_runtime import load_cli_config
