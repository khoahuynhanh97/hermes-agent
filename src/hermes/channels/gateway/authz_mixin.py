...
that uses it (``from hermes.channels.gateway.run import logger`` resolves at call time, when
...
from hermes.channels.gateway.whatsapp_identity import (
...
class GatewayAuthorizationMixin:
    ...
    def _is_user_authorized(self, source: SessionSource) -> bool:
        ...
        5. Default: deny
        """
        from hermes.channels.gateway.run import logger
