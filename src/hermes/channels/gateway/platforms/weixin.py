...
from hermes.channels.gateway.platforms.helpers import MessageDeduplicator, greedy_pack_blocks
...
async def _api_post(
    ...
    *,
    ...
    # invoked via asyncio.run_coroutine_threadsafe() from hermes.scheduling jobs.
...
def _split_table_row(line: str) -> List[str]:
    ...
    from hermes.agent.markdown_tables import split_table_row
...
class WeixinAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        # "Timeout context manager should be used inside a task" errors when
        # send() is invoked via asyncio.run_coroutine_threadsafe() from hermes.scheduling.
