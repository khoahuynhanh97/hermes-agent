...
from hermes.runtime.utils import normalize_proxy_url
...
def build_auto_tts_output_path(platform) -> str:
    ...
    """
    from hermes.tools.tts_tool import OPUS_VOICE_PLATFORMS
...
from hermes.runtime.constants import get_default_hermes_root, get_hermes_dir, get_hermes_home
...
async def _ssrf_redirect_guard(response):
    ...
    """
    from hermes.tools.url_safety import is_safe_url, redirect_target_from_response
...
def get_inbound_media_max_bytes() -> int:
    ...
    """
    try:
        from hermes.channels.cli.config import load_config_readonly as _load_config
...
def _sniff_audio_ext(data: bytes, fallback_ext: str) -> str:
    ...
    """
    from hermes.tools.audio_container import sniff_audio_ext
...
def cache_media_bytes(
    ...
    *,
    ...
    """
    from hermes.tools.credential_files import to_agent_visible_cache_path
...
class BasePlatformAdapter(ABC):
    ...
    def render_message_event(self, event: Any, sink: Any) -> None:
        ...
        """
        from hermes.channels.gateway.stream_events import MessageChunk, MessageStop, Commentary
    ...
    def format_tool_event(self, event: Any, *, mode: str = "all",
        ...
        """
        from hermes.channels.gateway.stream_events import ToolCallChunk
        ...
        if preview:
            from hermes.agent.display import prepare_tool_preview
    ...
    def _write_runtime_status_safe(self, context: str, **kwargs) -> None:
        ...
        """
        try:
            from hermes.channels.gateway.status import write_runtime_status
    ...
    def _release_platform_lock(self) -> None:
        ...
        if not identity:
            return
        from hermes.channels.gateway.status import release_scoped_lock
    ...
    def _history_media_paths_for_session(self, session_key: str) -> Optional[set]:
        ...
        from hermes.channels.gateway.run import _collect_history_media_paths
    ...
    async def send_clarify(
        ...
        if choices:
            ...
            _is_multi = False
            try:
                from hermes.tools import clarify_gateway as _cg
                with _cg._lock:
            ...
            if response:
                ...
                if text_content and not _tts_caption_delivered:
                    ...
                    if not is_ephemeral_response and not str(
                        ...
                        try:
                            from hermes.channels.gateway.delivery_ledger import (
    ...
    async def cancel_background_tasks(self) -> None:
        ...
        try:
            from hermes.channels.gateway.shutdown_flush import flush_pending_to_file
