...
from hermes.channels.gateway.config import Platform, PlatformConfig
from hermes.channels.gateway.platforms.base import (
...
from hermes.channels.gateway.readiness import collect_runtime_readiness

from hermes.agent.secret_scope import UnscopedSecretError as _UnscopedSecretError
from hermes.agent.secret_scope import get_secret as _scoped_get_secret
...
def _hermes_version() -> str:
    ...
    """
    try:
        from hermes.channels.cli import __version__
...
def _resolve_request_runtime_agent_kwargs(provider: str, target_model: Optional[str] = None) -> Dict[str, Any]:
    ...
    """
    from hermes.channels.cli.runtime_provider import resolve_runtime_provider, format_runtime_provider_error, _get_model_config
...
def _reap_disconnected_agent_processes(
    ...
    from hermes.channels.gateway.run import _reap_gateway_turn_processes
...
class ResponseStore:
    ...
    def __init__(self, max_size: int = MAX_STORED_RESPONSES, db_path: str = None):
        ...
        from hermes.state.service import apply_wal_with_fallback
...
try:
    from hermes.scheduling.jobs import (
...
def _notify_cron_provider_jobs_changed() -> None:
    ...
    try:
        from hermes.scheduling.scheduler import _notify_provider_jobs_changed
...
try:
    from hermes.tools.cronjob_tools import _scan_cron_prompt as _scan_cron_prompt
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    def _gateway_is_draining() -> bool:
        ...
        try:
            from hermes.channels.gateway.run import _gateway_runner_ref
    ...
    def _readiness_work_counts(self) -> tuple[int, int, int]:
        ...
        try:
            ...
            pass
        try:
            from hermes.tools.async_delegation import active_count
    ...
    def _resolve_model_name(explicit: str) -> str:
        ...
        """
        from hermes.channels.cli.model_switch import resolve_effective_model
    ...
    def _expected_api_key(self) -> str:
        ...
        try:
            from hermes.agent.secret_scope import get_secret
            from hermes.channels.cli.auth import has_usable_secret
    ...
    def _get_platform_callback_adapter(
        ...
        try:
            from hermes.channels.gateway.config import Platform as _Platform
    ...
    def _resolve_request_profile(self, request: "web.Request"):
        ...
        if not getattr(cfg, "multiplex_profiles", False):
            ...
            return None
        try:
            from hermes.channels.cli.profiles import profiles_to_serve
    ...
    def _profile_scope(profile: Optional[str]):
        ...
        if not profile:
            try:
                from hermes.agent.secret_scope import is_multiplex_active
            ...
            return nullcontext()
        from hermes.channels.gateway.run import _profile_runtime_scope
        from hermes.channels.cli.profiles import get_profile_dir
    ...
    def _create_agent(
        ...
        def _resolve_provider_runtime(
            ...
            *,
            ...
            try:
                ...
                try:
                    from hermes.channels.gateway.run import _resolve_runtime_agent_kwargs_for_provider
        ...
        # had to re-fix here after it diverged from hermes.channels.gateway/run.py.
        from hermes.channels.cli.model_switch import resolve_effective_model
        if session_override:
        ...
        if not model and runtime_kwargs.get("provider"):
            try:
                from hermes.channels.cli.models import get_default_model_for_provider
    ...
    async def _handle_health_detailed(self, request: "web.Request") -> "web.Response":
        ...
        from hermes.channels.gateway.run import _resolve_gateway_model
    ...
    async def _handle_skills(self, request: "web.Request") -> "web.Response":
        ...
        try:
            from hermes.tools.skills_tool import _find_all_skills, _sort_skills
    ...
    async def _handle_toolsets(self, request: "web.Request") -> "web.Response":
        ...
        try:
            ...
            from hermes.tools.toolsets import resolve_toolset
    ...
    async def _handle_create_session(self, request: "web.Request") -> "web.Response":
        ...
        from hermes.channels.gateway.session import _is_path_unsafe
    ...
    async def _handle_chat_completions(self, request: "web.Request") -> "web.Response":
        ...
        if stream:
            ...
            def _on_tool_start(tool_call_id, function_name, function_args):
                ...
                from hermes.agent.display import build_tool_preview, get_tool_emoji
    ...
    async def _write_sse_chat_completion(
        ...
        """Write real streaming SSE from hermes.agent's stream_delta_callback queue.
    ...
    async def _handle_cron_fire(self, request: "web.Request") -> "web.Response":
        ...
        """
        from hermes.channels.cli.config import cfg_get, load_config
        from hermes.integrations.plugins.cron_providers.chronos.verify import get_fire_verifier
        ...
        def _run():
            ...
            with self._profile_scope(request_profile):
                ...
                try:
                    ...
                    from hermes.security.ingress import principal_scope, build_api_principal
                    from hermes.security.principal import PrincipalContext
                    _api_princ = build_api_principal(effective_task_id)
                    if _api_princ is None:
                        if os.environ.get("HERMES_REQUIRE_API_AUTH", "false").lower() == "true":
                            from aiohttp import web
                            raise web.HTTPUnauthorized(reason="HERMES_API_OWNER_USER_ID is required but not configured")
                        _api_princ = PrincipalContext(
                            actor_id="api_user",
                    ...
                    with principal_scope(_api_princ):
                ...
                def _run_sync():
                    ...
                    with self._profile_scope(request_profile):
                        try:
                            ...
                            from hermes.security.ingress import principal_scope, build_api_principal
                            from hermes.security.principal import PrincipalContext
                            _api_princ2 = build_api_principal(effective_task_id) or PrincipalContext(
                                actor_id=os.environ.get("HERMES_API_OWNER_USER_ID", "api_user"),
                                owner_user_id=os.environ.get("HERMES_API_OWNER_USER_ID", "api_user"),
                                platform="api_server",
                                session_id=effective_task_id,
                                roles=("admin",),
                            )
                            with principal_scope(_api_princ2):
    ...
    async def _handle_run_approval(self, request: "web.Request") -> "web.Response":
        ...
        try:
            from hermes.tools.approval import resolve_gateway_approval
