...
from hermes.channels.gateway.platforms.media_cache import ext_for_mime
...
from hermes.channels.gateway.platforms.qqbot.constants import (
    API_BASE,
    TOKEN_URL,
    GATEWAY_URL_PATH,
    DEFAULT_API_TIMEOUT,
...
from hermes.channels.gateway.platforms.qqbot.utils import (
    coerce_list as _coerce_list_impl,
    build_user_agent,
)
from hermes.channels.gateway.platforms.qqbot.chunked_upload import (
    ChunkedUploader,
    UploadDailyLimitExceededError,
    UploadFileTooLargeError,
)
from hermes.channels.gateway.platforms.qqbot.keyboards import (
    ApprovalRequest,
    InlineKeyboard,
    InteractionEvent,
...
class QQAdapter(BasePlatformAdapter):
    ...
    async def send_approval_request(
        ...
        """
        from hermes.channels.gateway.platforms.qqbot.keyboards import build_approval_text
