...
from hermes.application.core.pending_store import PendingStore
from hermes.application.core.telegram_auth import is_authorized_update, is_authorized_user_id
from hermes.application.core.llm_gateway import complete as llm_complete, health_check, list_models
from hermes.application.core.conversation_memory import get_memory
from hermes.application.core.knowledge_store import get_store
from hermes.application.core.source_validation import validate_learning_source
...
from hermes.application.core.repository_search import (
    extract_repository_query,
    format_repository_context,
    is_repository_search_request,
    search_repositories,
)
from hermes.tools.script_generator import check_ollama, get_ollama_client
from hermes.application.core.router import resolve_route, get_mode, get_engine, MODE_LEARN_KNOWLEDGE, MODE_LEARN_VIDEO, MODE_LEARN_HOOK_CTA, MODE_SCRIPT_FROM_VIDEO
...
def build_video_job(
    ...
    try:
        if source_kind == "website_url":
            from hermes.tools.url_inspector import inspect_url
