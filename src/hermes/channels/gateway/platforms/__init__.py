...
# nothing in the codebase consumes ``from hermes.channels.gateway.platforms import
# QQAdapter`` (every real call site uses the long-form path
# ``from hermes.channels.gateway.platforms.qqbot import QQAdapter``). The eager imports
