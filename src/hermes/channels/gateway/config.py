...
from hermes.agent.secret_scope import current_secret_scope, get_secret as _get_secret
...
class GatewayConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        from hermes.channels.gateway.profile_routing import parse_profile_routes
    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            try:
                ...
                from hermes.channels.gateway.platform_registry import platform_registry as _pr
            except Exception as e:
