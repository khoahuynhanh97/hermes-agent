...
from hermes.runtime.constants import get_hermes_home, _get_platform_default_hermes_home
...
def write_runtime_status(
    *,
    ...
    try:
        from hermes.agent.monitoring.gateway_health import emit_runtime_status_transition
