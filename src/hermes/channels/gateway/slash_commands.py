...
inside the handler body — a deferred ``from hermes.channels.gateway.run import ...`` resolves at
...
from hermes.agent.i18n import t
from hermes.agent.turn_context import extract_api_content_sidecar
from hermes.channels.gateway.config import HomeChannel, Platform, PlatformConfig, persist_home_channel
from hermes.channels.gateway.platforms.base import EphemeralReply, MessageEvent, MessageType
from hermes.channels.gateway.session import (
    AsyncSessionStore,
    SessionSource,
    build_session_key,
    is_shared_multi_user_session,
)
from hermes.channels.cli.config import atomic_config_write, cfg_get, clear_model_endpoint_credentials
from hermes.runtime.utils import (
    atomic_json_write,
...
def _model_switch_skew_guard() -> Optional[str]:
    ...
    """
    from hermes.channels.gateway.code_skew import detect_code_skew
...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_reset_command(self, event: MessageEvent) -> Union[str, EphemeralReply]:
        ...
        # expiring durable session id (delegations dispatched from hermes.channels.gateway
        ...
        try:
            from hermes.tools.env_passthrough import clear_env_passthrough
            clear_env_passthrough()
        except Exception:
            pass

        try:
            from hermes.tools.credential_files import clear_credential_files
    ...
    async def _handle_profile_command(self, event: MessageEvent) -> str:
        ...
        """
        from hermes.runtime.constants import display_hermes_home
        ...
        if multiplexed:
            ...
            try:
                from hermes.channels.gateway.run import _profile_runtime_scope
    ...
    async def _handle_whoami_command(self, event: MessageEvent) -> str:
        ...
        """
        from hermes.channels.gateway.slash_access import policy_for_source as _policy_for_source
    ...
    async def _handle_kanban_command(self, event: MessageEvent) -> str:
        ...
        import re
        import shlex
        from hermes.channels.cli.kanban import run_slash
    ...
    async def _handle_status_command(self, event: MessageEvent) -> str:
        ...
        from hermes.channels.gateway.run import _AGENT_PENDING_SENTINEL, _load_gateway_config, _resolve_gateway_model
    ...
    async def _handle_context_command(self, event: MessageEvent) -> str:
        ...
        """
        from hermes.channels.gateway.run import _AGENT_PENDING_SENTINEL
    ...
    def _resume_caller_is_admin(self, source: SessionSource) -> bool:
        ...
        """
        try:
            from hermes.channels.gateway.slash_access import policy_for_source
    ...
    async def _handle_agents_command(self, event: MessageEvent) -> str:
        ...
        from hermes.channels.gateway.run import _AGENT_PENDING_SENTINEL
        from hermes.tools.process_registry import format_uptime_short, process_registry
        ...
        try:
            from hermes.tools.async_delegation import list_async_delegations
            delegations = [
    ...
    async def _handle_stop_command(self, event: MessageEvent) -> Union[str, EphemeralReply]:
        ...
        """
        from hermes.channels.gateway.run import _AGENT_PENDING_SENTINEL, _INTERRUPT_REASON_STOP
        source = event.source
        session_entry = await self.async_session_store.get_or_create_session(source)
        session_key = session_entry.session_key
    ...
    async def _handle_restart_command(self, event: MessageEvent) -> Union[str, EphemeralReply]:
        ...
        from hermes.channels.gateway.run import _hermes_home
        ...
        from hermes.channels.gateway.restart import (
    ...
    async def _handle_help_command(self, event: MessageEvent) -> str:
        ...
        from hermes.channels.gateway.run import _telegramize_command_mentions
        from hermes.channels.cli.slash_exec import CommandContext, execute_command
    ...
    async def _handle_model_command(self, event: MessageEvent) -> Optional[str]:
        ...
        """
        from hermes.channels.gateway.run import _hermes_home, _load_gateway_config
            ...
            if has_picker:
                ...
                if providers:
                    ...
                    async def _on_model_selected_scoped(
                        ...
                        try:
                            from hermes.channels.cli.context_switch_guard import (
                        ...
                        if persist_global:
                            try:
                                ...
                                if isinstance(_raw_model, dict):
                                    ...
                                    _persist_cfg["model"] = _persist_model_cfg
                                try:
                                    from hermes.channels.cli.route_identity import should_clear_context_pin_async
                                ...
                                from hermes.channels.cli.config import save_config
                        ...
                        from hermes.channels.cli.model_switch import resolve_display_context_length_async
                        _sw_config_ctx = None
                        _sw_model_cfg = {}
                        try:
    ...
    async def _handle_goal_command(self, event: "MessageEvent") -> str:
        ...
        if lower.startswith("draft"):
            ...
            try:
                import asyncio
                from hermes.channels.cli.goals import draft_contract
            ...
            from hermes.channels.cli.goals import parse_contract
    ...
    async def _handle_set_home_command(self, event: MessageEvent) -> str:
        ...
        from hermes.channels.gateway.run import _home_target_env_var, _home_thread_env_var
        source = event.source
        ...
        try:
            from hermes.channels.cli.config import save_env_value
    ...
    async def _handle_rollback_command(self, event: MessageEvent) -> str:
        ...
        from hermes.channels.gateway.run import _checkpoint_agent_kwargs, _load_gateway_config
        from hermes.tools.checkpoint_manager import CheckpointManager, format_checkpoint_list
    ...
    async def _handle_diff_command(self, event: MessageEvent) -> str:
        ...
        from hermes.tools.working_diff import collect_working_diff
    ...
    async def _gateway_session_diff(self, cwd: str, stat_only: bool) -> str:
        ...
        from hermes.channels.gateway.run import _checkpoint_agent_kwargs, _load_gateway_config
        from hermes.tools.checkpoint_manager import CheckpointManager
    ...
    def _reasoning_picker_choices(self, current_effort: str) -> list:
        ...
        from hermes.runtime.constants import VALID_REASONING_EFFORTS
    ...
    async def _handle_reasoning_command(self, event: MessageEvent) -> Optional[str]:
        ...
        """
        from hermes.channels.gateway.run import _platform_config_key
    ...
    async def _handle_memory_command(self, event: MessageEvent) -> str:
        ...
        """
        from hermes.channels.gateway.run import _hermes_home
        from hermes.channels.cli.write_approval_commands import handle_pending_subcommand
        from hermes.tools import write_approval as wa
        from hermes.tools.memory_tool import load_on_disk_store
    ...
    async def _handle_fast_command(self, event: MessageEvent) -> Optional[str]:
        ...
        """
        from hermes.channels.gateway.run import _load_gateway_config, _resolve_gateway_model
    ...
    async def _handle_approvals_command(self, event: MessageEvent) -> str:
        ...
        from hermes.channels.gateway.slash_access import policy_for_source
        from hermes.channels.cli.approval_mode import run_approval_mode_command
    ...
    async def _handle_verbose_command(self, event: MessageEvent) -> str:
        ...
        """
        from hermes.channels.gateway.run import _hermes_home, _load_gateway_config, _platform_config_key
        ...
        from hermes.channels.gateway.display_config import resolve_display_setting
    ...
    async def _handle_footer_command(self, event: MessageEvent) -> str:
        ...
        """
        from hermes.channels.gateway.run import _hermes_home, _load_gateway_config, _platform_config_key, _resolve_gateway_model
        from hermes.channels.gateway.runtime_footer import resolve_footer_config
        ...
        if new_state:
            ...
            from hermes.channels.gateway.runtime_footer import format_runtime_footer
    ...
    async def _handle_compress_command_inner(self, event: MessageEvent) -> str:
        ...
        try:
            ...
            from hermes.channels.gateway.run import (
    ...
    async def _handle_sessions_command(self, event: MessageEvent) -> str:
        ...
        from hermes.channels.cli.session_listing import (
    ...
    async def _handle_topup_command(self, event: MessageEvent) -> str:
        ...
        """
        from hermes.agent.account_usage import build_credits_view
    ...
    def _context_breakdown_lines(self, agent, source) -> list[str]:
        ...
        """
        try:
            from hermes.agent.context_breakdown import compute_session_context_breakdown
    ...
    async def _handle_usage_command(self, event: MessageEvent) -> str:
        ...
        try:
            from hermes.agent.account_usage import nous_credits_lines
        ...
        if agent and hasattr(agent, "session_total_tokens") and agent.session_api_calls > 0:
            ...
            if rl_state and rl_state.has_data:
                from hermes.agent.rate_limit_tracker import format_rate_limit_compact
    ...
    async def _handle_reload_mcp_command(self, event: MessageEvent) -> Optional[str]:
        ...
        async def _on_confirm(choice: str) -> Optional[str]:
            ...
            if choice == "always":
                ...
                try:
                    from hermes.channels.cli.classic_runtime import save_config_value
    ...
    async def _handle_reload_skills_command(self, event: MessageEvent) -> str:
        ...
        loop = asyncio.get_running_loop()
        try:
            from hermes.agent.skill_commands import reload_skills
    ...
    async def _handle_debug_command(self, event: MessageEvent) -> str:
        ...
        """
        import asyncio
        from hermes.channels.cli.debug import (
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        ...
        """
        from hermes.channels.gateway.run import _hermes_home, _resolve_hermes_bin
        import json
        import shutil
        import subprocess
        from datetime import datetime
        from hermes.channels.cli.config import is_managed, format_managed_message
        ...
        try:
            if sys.platform == "win32":
                import textwrap
                from hermes.channels.cli._subprocess_compat import windows_detach_popen_kwargs
