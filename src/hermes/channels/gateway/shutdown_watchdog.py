...
from hermes.channels.gateway.restart import GATEWAY_SERVICE_RESTART_EXIT_CODE
    ...
    *,
    ...
    def _watchdog() -> None:
        ...
        while not stop_event.wait(timeout=interval):
            ...
            try:
                from hermes.channels.gateway.lifecycle_ledger import mark_exited
...
def write_loop_heartbeat(
    *,
    ...
    try:
        from hermes.channels.gateway.lifecycle_ledger import sample_memory
...
def arm_shutdown_watchdog(
    ...
    *,
    ...
    def _watchdog() -> None:
        ...
        try:
            from hermes.channels.gateway.status import remove_pid_file, release_gateway_runtime_lock
            remove_pid_file()
            release_gateway_runtime_lock()
        except Exception:
            pass
        try:
            from hermes.runtime.logging import drain_log_queue
