...
def _acquire_singleton_lock(lock_path) -> "tuple[Optional[object], str]":
    ...
    """
    try:
        from hermes.channels.gateway.status import _try_acquire_file_lock  # deferred; same package
    except ImportError:
...
def _release_singleton_lock(handle) -> None:
    ...
    if handle is None:
        return
    try:
        from hermes.channels.gateway.status import _release_file_lock
...
class GatewayKanbanWatchersMixin:
            ...
            try:
                ...
                for d in deliveries:
                    ...
                    for ev in d["events"]:
                        ...
                        from hermes.channels.gateway.wake import adapter_supports_push
                        ...
                        from hermes.channels.gateway.wake import adapter_supports_push as _adapter_push_ok
                        ...
                        if not _is_push_adapter and _wake_kinds and _session_key:
                            ...
                            from hermes.channels.gateway.wake import deliver_wake
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        def _auto_decompose_tick(auto_decompose_per_tick: int) -> int:
            ...
            """
            try:
                from hermes.channels.cli import kanban_decompose as _decomp
