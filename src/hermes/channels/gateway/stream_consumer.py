...
from hermes.channels.gateway.platforms.base import BasePlatformAdapter as _BasePlatformAdapter
from hermes.channels.gateway.platforms.base import _custom_unit_to_cp
from hermes.channels.gateway.platforms.base import MEDIA_TAG_CLEANUP_RE
from hermes.channels.gateway.config import (
    DEFAULT_STREAMING_EDIT_INTERVAL as _DEFAULT_STREAMING_EDIT_INTERVAL,
    DEFAULT_STREAMING_BUFFER_THRESHOLD as _DEFAULT_STREAMING_BUFFER_THRESHOLD,
    DEFAULT_STREAMING_CURSOR as _DEFAULT_STREAMING_CURSOR,
)
from hermes.channels.gateway.response_filters import (
...
class GatewayStreamConsumer:
    ...
    # MEDIA_TAG_CLEANUP_RE from hermes.channels.gateway/platforms/base.py — only tags whose
    ...
    def _balance_fences_across_chunks(chunks: "list[str]") -> "list[str]":
        ...
        """
        from hermes.channels.gateway.platforms.helpers import balance_fences_across_chunks
    ...
    def _split_text_chunks(
        ...
        """
        from hermes.channels.gateway.platforms.helpers import split_text_fence_aware
