...
from hermes.channels.gateway.platforms.base import BasePlatformAdapter, MessageEvent, SendResult
from hermes.channels.gateway.relay.descriptor import CapabilityDescriptor
from hermes.channels.gateway.relay.media import RelayMediaClient
from hermes.channels.gateway.relay.transport import RelayTransport
...
class RelayAdapter(BasePlatformAdapter):
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        from hermes.channels.gateway.platforms.base import MessageType
    ...
    def _get_media_client(self) -> Optional[RelayMediaClient]:
        ...
        try:
            from hermes.channels.gateway.relay import relay_connection_auth, relay_url
            from hermes.channels.gateway.relay.media import media_base_url
    ...
    async def _consume_prompt_response(self, event) -> bool:
        ...
        try:
            if kind == "exec_approval":
                ...
                from hermes.tools import slash_confirm as slash_confirm_mod
                ...
                from hermes.tools.clarify_gateway import (
                    mark_awaiting_text,
    ...
    async def on_processing_complete(self, event, outcome) -> None:
        ...
        from hermes.channels.gateway.platforms.base import ProcessingOutcome
