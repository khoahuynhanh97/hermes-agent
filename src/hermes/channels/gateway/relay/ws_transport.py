...
from hermes.channels.gateway.platforms.base import MessageEvent, MessageType
...
from hermes.channels.gateway.relay.transport import InboundHandler
...
class WebSocketRelayTransport:
    ...
    async def _dial_and_start(self) -> None:
        ...
        for platform, bot_id in self._identities:
            ...
            if platform == "discord":
                try:
                    from hermes.channels.gateway.relay.command_manifest import build_relay_command_manifest
