...
# Add root folder to python path to from hermes.application import core files
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))

from hermes.runtime import config
from hermes.application.core.project_manager import ProjectManager
from hermes.application.core.agent_jobs import AgentJobManager, DEFAULT_TASKS
from hermes.application.core.keyword_generator import generate_keywords, translate_to_zh
from hermes.application.core.script_generator import generate_script, save_script_files, SCRIPT_STYLES
from hermes.application.core.file_manager import list_downloaded_materials
from hermes.integrations.providers.url_list_provider import download_url_list
...
from hermes.integrations.providers.supplier_feed_provider import run_supplier_feed_provider
from hermes.integrations.providers.custom_scraper_adapter import run_custom_scraper
from hermes.integrations.providers.ai_video_provider import AI_VIDEO_PROVIDER_CHOICES, generate_ai_video_materials
...
from hermes.integrations.providers.smart_crawler_provider import (
    parse_shopee_url,
...
from hermes.video.editor.audio_helper import get_audio_duration
from hermes.video.editor.video_editor import build_tiktok_video
from hermes.video.editor.clip_cutter import cut_single_clip
from hermes.channels.gui.components import ConsoleView, LabeledEntry, LabeledTextbox, StatusIndicator, CollapsibleSection, SectionHeader
from hermes.channels.gui.theme import COLORS, apply_theme, font, primary_button_kwargs, secondary_button_kwargs
from hermes.application.core.idea_engine import generate_ideas, save_ideas, load_ideas, save_selected_angles, load_selected_angles
from hermes.application.core.prompt_engine import generate_prompts_from_storyboard
from hermes.application.core.clip_library import ClipLibrary, CLIP_STATUSES, ASSET_TYPES, SCENE_TYPES
from hermes.application.core.learning_review import LearningReviewStore
import hermes.application.core.knowledge_base as kb
import hermes.application.core.project_creator as pc
from hermes.channels.gui.tabs.settings_tab import SettingsTab
from hermes.channels.gui.tabs.learn_review_tab import LearnReviewTab
from hermes.channels.gui.tabs.idea_engine_tab import IdeaEngineTab
from hermes.channels.gui.tabs.script_generator_tab import ScriptGeneratorTab
from hermes.channels.gui.tabs.audio_generator_tab import AudioGeneratorTab
from hermes.channels.gui.tabs.storyboard_tab import StoryboardTab
from hermes.channels.gui.tabs.agent_jobs_tab import AgentJobsTab
from hermes.channels.gui.tabs.assistant_tab import AssistantTab
from hermes.channels.gui.tabs.content_recycler_tab import ContentRecyclerTab
...
class HermesTikTokVideoFactoryApp(ctk.CTk):
    ...
    def run_manual_translation_zh(self):
        ...
        def run():
            from hermes.application.core.keyword_generator import translate_to_zh
    ...
    def save_settings(self):
        try:
            ...
            try:
                from hermes.application.core import ai_router as _ar
                _ar._router = None
            except Exception:
                pass
