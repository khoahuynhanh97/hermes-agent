...
class HermesTikTokVideoFactoryApp(ctk.CTk):
    ...
    def _tts_generate(self):
        ...
        def run_tts():
            try:
                from hermes.tools.tts_engine import synthesize
    ...
    def start_storyboard_generation(self):
        ...
        def run():
            ...
            from hermes.application.core.storyboard_generator import generate_storyboard
    ...
    def save_storyboard(self):
        ...
        from hermes.application.core.file_manager import to_slug
        ...
        from hermes.application.core.storyboard_writer import save_storyboard_outputs
