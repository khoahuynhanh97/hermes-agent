...
from hermes.agent.message_sanitization import _sanitize_surrogates
...
from hermes.channels.cli.sqlite_runtime import (
    is_sqlite_wal_reset_vulnerable as _is_sqlite_wal_reset_vulnerable,
)
from typing import Any, Callable, Dict, List, Optional, Tuple, TypeVar

from hermes.state.common import (  # noqa: F401  (re-exported for back-compat)
    _BRANCH_CHILD_SQL,
...
from hermes.state.portability import SessionPortabilityMixin
from hermes.state.schema import SessionSchemaMixin
from hermes.state.search import SessionSearchMixin
...
def is_zeroed_state_db(
    ...
    """
    try:
        from hermes.channels.cli.backup import is_zeroed_sqlite_file
...
class SessionDB(SessionSearchMixin, SessionSchemaMixin, SessionPortabilityMixin):
    ...
    def get_session_activity(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        if not row:
            return None
        from hermes.agent.session_activity import build_activity_snapshot
