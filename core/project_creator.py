...
from core.script_generator import generate_script, save_script_files
from core.keyword_generator import extract_smart_keywords
from core.visual_matcher import filter_materials_by_reference
